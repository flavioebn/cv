export const Spells = [
  ...
  },
  {
    ...
    damageInflict: ["acid", "cold", "fire", "lightning", "necrotic", "poison"],
    conditionInflict: ["frightened"],
    savingThrow: ["wisdom", "intelligence"],
    abilityCheck: ["intelligence"],
    miscTags: ["SGT", "UBA"],
    areaTags: ["N"],
  },
  ...
  },
  {
    ...
    entries: ["You are immune to all damage until the spell ends."],
  },
  {
  ...
  },
  {
    ...
    damageImmune: ["poison", "psychic"],
    miscTags: ["PIR", "PRM", "SGT"],
    hasFluffImages: true,
  },
  {
    name: "Mind Spike",
  ...
  },
  {
    ...
    damageResist: ["acid", "cold", "fire", "lightning", "thunder"],
    damageImmune: ["acid", "cold", "fire", "lightning", "thunder"],
  },
  {
    name: "Psychic Scream",
    source: "XGE",
    ...
    entriesHigherLevel: [
      {
        ...
        name: "At Higher Levels",
        entries: [
          "When you cast this spell using a 3rd- or 4th-level spell slot, the damage increases to {@damage 3d8}. When you cast it using a 5th- or 6th-level spell slot, the damage increases to {@damage 4d8}. When you cast it using a spell slot of 7th level or higher, the damage increases to {@damage 5d8}.",
        ],
      },
    ],
    damageInflict: ["psychic"],
  ...
  },
  {
    ...
    damageInflict: ["bludgeoning", "lightning"],
    spellAttack: ["R"],
    savingThrow: ["strength"],
    miscTags: ["DFT", "UBA"],
    areaTags: ["S", "ST"],
  ...
  },
  {
    ...
    entries: [
      ...
      {
        type: "table",
        colLabels: ["{@dice d6}", "Demons Summoned"],
        colStyles: ["col-1 text-center", "col-11"],
        rows: [
          [
            {
  ...
  },
  {
    ...
    damageInflict: ["bludgeoning", "slashing"],
    conditionInflict: ["prone", "restrained"],
    spellAttack: ["R"],
    savingThrow: ["dexterity", "strength"],
    abilityCheck: ["strength"],
    miscTags: ["DFT", "SGT", "UBA"],
    areaTags: ["C", "ST"],
  },
  {
    name: "Zephyr Strike",
  ...
  },
  {
    ...
    entries: [
      "When you cast this spell, you gain one {@adventure level of contamination|DoDk|12}. Octarine rays of light flash from your hand. Each ray is a different colour and has a different power and purpose, see the table below. Each creature in a 60-foot cone must succeed on a Constitution saving throw. For each target, roll a {@dice d8} to determine which colour ray affects it.",
      {
        type: "table",
        colStyles: ["col-2 text-center", "col-10"],
        colLabels: ["d8", "Octarine Spray Effect"],
        rows: [
          [
            "1",
    ...
    damageInflict: ["force", "necrotic", "psychic", "radiant", "thunder"],
    savingThrow: ["constitution", "wisdom"],
    miscTags: ["RO"],
  },
  {
  ...
  },
  {
    ...
    damageInflict: ["psychic", "force", "cold"],
    conditionInflict: ["stunned", "prone", "blinded"],
        ...
        items: [
          {
            type: "item",
            name: "Cover",
            entries: ["The creature has {@quickref Cover||3||half cover}."],
          },
          {
            type: "item",
  ...
  },
  {
    ...
    conditionInflict: ["invisible", "restrained", "unconscious"],
    miscTags: ["SGT"],
  },
  {
    name: "Wrack",
  ...
  },
  {
    ...
    damageInflict: ["radiant", "necrotic", "cold"],
    miscTags: ["SGT"],
  },
  {
  ...
  },
  {
    ...
    damageImmune: ["fire", "poison", "radiant", "necrotic"],

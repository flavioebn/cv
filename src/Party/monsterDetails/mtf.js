export const mtfMonsters = [
  ...
  },
  {
    ...
    source: "MTF",
    page: 212,
    reprintedAs: ["Adult Kruthik|MPMM"],
    size: ["M"],
    type: "monstrosity",
    alignment: ["U"],
    ac: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The kruthik makes two stab attacks or two spike attacks."],
      },
      {
        name: "Stab",
        entries: [
    ...
    traitTags: ["Keen Senses", "Pack Tactics", "Tunneler"],
    senseTags: ["D", "T"],
  ...
  },
  {
    ...
    conditionInflictSpell: ["blinded", "charmed", "paralyzed"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    reprintedAs: ["Air Elemental Myrmidon|MPMM"],
    size: ["M"],
    type: "elemental",
    alignment: ["N"],
    ac: [
    ...
    trait: [
      {
        name: "Magic Weapons",
        entries: ["The myrmidon's weapon attacks are magical."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: [
          ...
          "If the saving throw against Foment Madness fails by 5 or more, the creature is instead subjected to the {@spell confusion} spell for 1 minute (no {@status concentration} required by the alkilith). While under the effect of that confusion, the creature is immune to Foment Madness.",
        ],
      },
      {
    ...
    traitTags: ["Amorphous", "False Appearance", "Magic Resistance"],
    senseTags: ["SD"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell charm person}", "{@spell command}"],
        daily: {
          "3e": ["{@spell dominate person}", "{@spell fireball}"],
          "1e": ["{@spell dominate monster}", "{@spell feeblemind}"],
        },
        ability: "int",
      },
    ],
    trait: [
      {
        name: "Devil's Sight",
        entries: ["Magical darkness doesn't impede the amnizu's darkvision."],
      },
      {
        name: "Magic Resistance",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The armanite's weapon attacks are magical."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    source: "MTF",
    page: 117,
    reprintedAs: ["Astral Dreadnought|MPMM"],
    size: ["G"],
    type: {
      type: "monstrosity",
      tags: ["titan"],
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["An astral dreadnought's weapon attacks are magical."],
      },
      {
    ...
    legendary: [
      {
        name: "Claw",
        entries: ["The astral dreadnought makes one claw attack."],
      },
      {
    ...
    traitTags: ["Legendary Resistances", "Magic Weapons"],
    senseTags: ["SD"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 195,
    reprintedAs: ["Autumn Eladrin|MPMM"],
    size: ["M"],
    type: {
      type: "fey",
      tags: ["elf"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell calm emotions}", "{@spell sleep}"],
        daily: {
          "3e": [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Bael's weapon attacks are magical."],
      },
      {
        name: "Regeneration",
        entries: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Bael makes two melee attacks."],
      },
      {
    ...
    legendary: [
      {
        ...
        entries: ["Bael attacks once with his hellish morningstar."],
      },
      {
        name: "Awaken Greed",
        entries: ["Bael casts {@spell charm person} or major image."],
      },
      {
        name: "Infernal Command",
        entries: ["Bael uses his Infernal Command action."],
      },
      {
        name: "Teleport",
        entries: ["Bael uses his Teleport action."],
      },
    ],
    soundClip: {
      type: "internal",
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Baphomet's weapon attacks are magical."],
      },
      {
        name: "Reckless",
        entries: [
    ...
    legendary: [
      {
        ...
        entries: ["Baphomet makes a melee attack with Heartcleaver."],
      },
      {
        name: "Charge (Costs 2 Actions)",
        entries: ["Baphomet moves up to his speed, then makes a gore attack."],
      },
    ],
    legendaryGroup: {
      name: "Baphomet",
  ...
  },
  {
    ...
    source: "MTF",
    page: 160,
    reprintedAs: ["Black Abishai|MPMM"],
    size: ["M"],
    type: {
      type: "fiend",
      tags: ["devil"],
    ...
    trait: [
      {
        name: "Devil's Sight",
        entries: ["Magical darkness doesn't impede the abishai's darkvision."],
      },
      {
        name: "Magic Resistance",
        entries: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The abishai's weapon attacks are magical."],
      },
      {
        name: "Shadow Stealth",
        entries: [
    ...
    traitTags: ["Devil's Sight", "Magic Resistance", "Magic Weapons"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The boneclaw makes two claw attacks."],
      },
      {
        name: "Piercing Claw",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 125,
    reprintedAs: ["Clockwork Bronze Scout|MPMM"],
    size: ["M"],
    type: "construct",
    alignment: ["U"],
    ac: [13],
  ...
  },
  {
    ...
    source: "MTF",
    page: 122,
    reprintedAs: ["Cadaver Collector|MPMM"],
    size: ["L"],
    type: "construct",
    alignment: ["L", "E"],
    ac: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The cadaver collector makes two slam attacks."],
      },
      {
        name: "Slam",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Uncanny Senses",
        entries: [
          "The canoloth can't be {@quickref Surprise|PHB|3|0|surprised} while it isn't {@condition incapacitated}.",
        ],
      },
    ],
    action: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 127,
    reprintedAs: ["Corpse Flower|MPMM"],
    size: ["L"],
    type: "plant",
    alignment: ["C", "E"],
    ac: [12],
  ...
  },
  {
    ...
    languageTags: ["LF"],
    damageTags: ["N"],
    damageTagsSpell: ["A", "C", "N", "O"],
    spellcastingTags: ["CL", "I"],
    miscTags: ["MW"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
    _versions: [
      ...
      {
        name: "Deathlock (Great Old One Patron)",
        source: "MTF",
        _mod: {
          spellcasting: {
            mode: "replaceArr",
  ...
  },
  {
    ...
    reprintedAs: ["Deathlock Mastermind|MPMM"],
    size: ["M"],
    type: "undead",
    alignment: ["L", "E"],
    ac: [
    ...
    _versions: [
      {
        name: "Deathlock Mastermind (Archfey Patron)",
        source: "MTF",
        _mod: {
          spellcasting: {
            mode: "replaceArr",
      ...
      {
        name: "Deathlock Mastermind (Fiend Patron)",
        source: "MTF",
        _mod: {
          spellcasting: {
            mode: "replaceArr",
      ...
      {
        name: "Deathlock Mastermind (Great Old One Patron)",
        source: "MTF",
        _mod: {
          spellcasting: {
            mode: "replaceArr",
  ...
  },
  {
    ...
    reprintedAs: ["Deathlock Wight|MPMM"],
    size: ["M"],
    type: "undead",
    alignment: ["L", "E"],
    ac: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The wight attacks twice with Grave Bolt."],
      },
      {
        name: "Grave Bolt",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Demogorgon's weapon attacks are magical."],
      },
      {
        name: "Two Heads",
        entries: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Demogorgon makes two tentacle attacks."],
      },
      {
        name: "Tentacle",
        entries: [
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 3,
            spells: ["{@spell invisibility}", "{@spell spider climb}"],
          },
          3: {
            slots: 2,
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The dhergoloth's weapon attacks are magical."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    source: "MTF",
    page: 182,
    reprintedAs: ["Drow Arachnomancer|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 183,
    reprintedAs: ["Drow Favored Consort|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The drow makes three scimitar attacks."],
      },
      {
        name: "Scimitar",
        entries: [
    ...
    attachedItems: ["hand crossbow|phb", "scimitar|phb"],
    traitTags: ["Fey Ancestry", "Sunlight Sensitivity"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["E", "U"],
    damageTags: ["I", "P", "S"],
    damageTagsSpell: ["C", "F", "I", "L", "O", "T"],
    spellcastingTags: ["CW", "I"],
    miscTags: ["MW", "RNG", "RW"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 184,
    reprintedAs: ["Drow House Captain|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 184,
    reprintedAs: ["Drow Inquisitor|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell dancing lights}", "{@spell detect magic}"],
        daily: {
          "1e": [
            "{@spell clairvoyance}",
            "{@spell darkness}",
      ...
      },
      {
        ...
        spells: {
          ...
          6: {
            slots: 1,
            spells: ["{@spell harm}", "{@spell true seeing}"],
          },
        },
        ability: "wis",
      },
    ...
    traitTags: ["Fey Ancestry", "Magic Resistance", "Sunlight Sensitivity"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["E", "U"],
    damageTags: ["N", "P", "Y"],
    damageTagsSpell: ["I", "N", "O", "P"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 186,
    reprintedAs: ["Drow Matron Mother|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
    ...
    spellcasting: [
      ...
      },
      {
        ...
        spells: {
          ...
          6: {
            slots: 2,
            spells: ["{@spell blade barrier}", "{@spell harm}"],
          },
          7: {
            slots: 2,
            spells: ["{@spell divine word}", "{@spell plane shift}"],
          },
          8: {
            slots: 1,
            spells: ["{@spell holy aura}"],
          },
          9: {
            slots: 1,
            spells: ["{@spell gate}"],
    ...
    legendary: [
      {
        name: "Demon Staff",
        entries: ["The drow makes one attack with her demon staff."],
      },
      {
  ...
  },
  {
    ...
    source: "MTF",
    page: 187,
    reprintedAs: ["Drow Shadowblade|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 188,
    reprintedAs: ["Duergar Despot|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
  ...
  },
  {
    ...
    reprintedAs: ["Duergar Hammerer|MPMM"],
    size: ["M"],
    type: "construct",
    alignment: ["L", "E"],
    ac: [
  ...
  },
  {
    ...
    reprintedAs: ["Duergar Kavalrachni|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
  ...
  },
  {
    ...
    reprintedAs: ["Duergar Mind Master|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
    ...
    action: [
      ...
      },
      {
        ...
        entries: [
          "The duergar magically turns {@condition invisible} for up to 1 hour or until it attacks, it casts a spell, it uses its Reduce, or its {@status concentration} is broken (as if {@status concentration||concentrating} on a spell). Any equipment the duergar wears or carries is {@condition invisible} with it.",
        ],
      },
      {
        name: "Mind Mastery",
  ...
  },
  {
    ...
    source: "MTF",
    page: 190,
    reprintedAs: ["Duergar Screamer|MPMM"],
    size: ["M"],
    type: "construct",
    alignment: ["L", "E"],
    ac: [
  ...
  },
  {
    ...
    reprintedAs: ["Duergar Soulblade|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell blade ward}", "{@spell true strike}"],
        daily: {
          "3e": ["{@spell jump}", "{@spell hunter's mark}"],
        },
        ability: "wis",
      },
    ],
    ...
    action: [
      ...
      },
      {
        ...
        entries: [
          "The duergar magically turns {@condition invisible} for up to 1 hour or until it attacks, it casts a spell, it uses its Enlarge, or its {@status concentration} is broken (as if {@status concentration||concentrating} on a spell). Any equipment the duergar wears or carries is {@condition invisible} with it.",
        ],
      },
    ],
    environment: ["mountain", "underdark"],
  ...
  },
  {
    ...
    reprintedAs: ["Duergar Stone Guard|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 192,
    reprintedAs: ["Duergar Warlord|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
  ...
  },
  {
    ...
    reprintedAs: ["Duergar Xarrorn|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["dwarf"],
    ...
    spellcasting: [
      {
        ...
        daily: {
          "3e": ["{@spell fear}", "{@spell phantasmal force}"],
        },
        ability: "cha",
      },
    ],
  ...
  },
  {
    ...
    reprintedAs: ["Earth Elemental Myrmidon|MPMM"],
    size: ["M"],
    type: "elemental",
    alignment: ["N"],
    ac: [
    ...
    trait: [
      {
        name: "Incorporeal Movement",
        entries: [
          "The eidolon can move through other creatures and objects as if they were {@quickref difficult terrain||3}. It takes 5 ({@damage 1d10}) force damage if it ends its turn inside an object other than a sacred statue.",
        ],
      },
      {
  ...
  },
  {
    ...
    source: "MTF",
    page: 200,
    reprintedAs: ["Elder Tempest|MPMM"],
    size: ["G"],
    type: "elemental",
    alignment: ["N"],
    ac: [19],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The tempest makes two attacks with its thunderous slam."],
      },
      {
  ...
  },
  {
    ...
    reprintedAs: ["Female Steeder|MPMM"],
    size: ["L"],
    type: "monstrosity",
    alignment: ["U"],
    ac: [
  ...
  },
  {
    ...
    reprintedAs: ["Fire Elemental Myrmidon|MPMM"],
    size: ["M"],
    type: "elemental",
    alignment: ["N"],
    ac: [
    ...
    attachedItems: ["scimitar|phb"],
    traitTags: ["Illumination", "Magic Weapons"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["IG"],
    damageTags: ["C", "F", "S"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Fraz-Urb'luu's weapon attacks are magical."],
      },
      {
        name: "Undetectable",
        entries: [
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: [
          "Fraz-Urb'luu casts {@spell phantasmal killer}, no {@status concentration} required.",
        ],
      },
    ],
    legendaryGroup: {
  ...
  },
  {
    ...
    source: "MTF",
    page: 223,
    reprintedAs: ["Frost Salamander|MPMM"],
    size: ["H"],
    type: "elemental",
    alignment: ["U"],
    ac: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Geryon's weapon attacks are magical."],
      },
      {
        name: "Regeneration",
        entries: [
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["Geryon attacks with his stinger."],
      },
      {
        name: "Teleport",
        entries: ["Geryon uses his Teleport action."],
      },
    ],
    legendaryGroup: {
      name: "Geryon",
    ...
    damageTagsSpell: ["B", "C", "N", "P", "S", "Y"],
    spellcastingTags: ["I"],
    miscTags: ["HPR", "MW", "RCH"],
    conditionInflict: ["frightened", "grappled", "poisoned", "restrained"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The giff makes two pistol attacks."],
      },
      {
        name: "Longsword",
        entries: [
  ...
  },
  {
    ...
    reprintedAs: ["Githyanki Gish|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["gith"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The githyanki makes two longsword attacks."],
      },
      {
        name: "Longsword",
        entries: [
    ...
    languageTags: ["GTH"],
    damageTags: ["S", "Y"],
    damageTagsSpell: ["F", "O", "T"],
    spellcastingTags: ["CW", "I", "P"],
    miscTags: ["MW"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    source: "MTF",
    page: 205,
    reprintedAs: ["Githyanki Kith'rak|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["gith"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 206,
    reprintedAs: ["Githyanki Supreme Commander|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["gith"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The githyanki makes two greatsword attacks."],
      },
      {
    ...
    legendary: [
      {
        ...
        entries: ["The githyanki makes a greatsword attack."],
      },
      {
        name: "Command Ally",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 207,
    reprintedAs: ["Githzerai Anarch|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["gith"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The anarch makes three unarmed strikes."],
      },
      {
        name: "Unarmed Strike",
        entries: [
    ...
    legendary: [
      {
        name: "Strike",
        entries: ["The anarch makes one unarmed strike."],
      },
      {
        name: "Teleport",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 208,
    reprintedAs: ["Githzerai Enlightened|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["gith"],
    ...
    spellcasting: [
      {
        ...
        daily: {
          ...
          "1e": ["{@spell haste}", "{@spell plane shift}", "{@spell teleport}"],
        },
        ability: "wis",
      },
    ],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The githzerai makes three unarmed strikes."],
      },
      {
        name: "Unarmed Strike",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 224,
    reprintedAs: ["Shadar-kai Gloom Weaver|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
    ...
    spellcasting: [
      ...
      },
      {
        ...
        footerEntries: ["*3 beams +4 bonus to each damage roll"],
        ability: "cha",
      },
    ],
    trait: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Graz'zt's weapon attacks are magical."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["Graz'zt attacks twice with Wave of Sorrow."],
      },
      {
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Graz'zt attacks once with Wave of Sorrow."],
      },
      {
      ...
      },
      {
        name: "Sow Discord",
        entries: [
          "Graz'zt casts {@spell crown of madness} or dissonant whispers.",
        ],
      },
      {
        name: "Teleport",
        entries: ["Graz'zt uses his Teleport action."],
      },
    ],
    legendaryGroup: {
      name: "Graz'zt",
  ...
  },
  {
    ...
    source: "MTF",
    page: 162,
    reprintedAs: ["Green Abishai|MPMM"],
    size: ["M"],
    type: {
      type: "fiend",
      tags: ["devil"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 165,
    reprintedAs: ["Hellfire Engine|MPMM"],
    size: ["H"],
    type: "construct",
    alignment: ["L", "E"],
    ac: [
          ...
          "The hellfire engine uses one of the following options:",
          {
            ...
            items: [
              ...
              },
              {
                ...
                name: "Thunder Cannon",
                entry:
                  "The hellfire engine targets a point within 120 feet of it that it can see. Each creature within 30 feet of that point must make a {@dc 20} Dexterity saving throw, taking 27 ({@damage 5d10}) bludgeoning damage plus 13 ({@damage 2d12}) thunder damage on a failed save, or half as much damage on a successful one.",
              },
            ],
          },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The howler makes two bite attacks."],
      },
      {
        name: "Rending Bite",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          ...
          "1e": ["{@spell heal}", "{@spell symbol} (hopelessness only)"],
        },
        ability: "cha",
      },
    ],
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Hutijin's weapon attacks are magical."],
      },
      {
        name: "Regeneration",
        entries: [
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Hutijin attacks once with his mace."],
      },
      {
      ...
      {
        name: "Teleport",
        entries: ["Hutijin uses his Teleport action."],
      },
    ],
    soundClip: {
      type: "internal",
    ...
    actionTags: ["Multiattack", "Teleport"],
    languageTags: ["TP", "XX"],
    damageTags: ["B", "I", "L", "P", "S"],
    damageTagsSpell: ["B", "F", "L", "N", "P", "S"],
    spellcastingTags: ["I"],
    miscTags: ["AOE", "MW", "RCH"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The hydroloth's weapon attacks are magical."],
      },
      {
        name: "Secure Memory",
        entries: [
    ...
    traitTags: ["Amphibious", "Magic Resistance", "Magic Weapons"],
    senseTags: ["B", "D"],
    actionTags: ["Multiattack", "Teleport"],
    languageTags: ["AB", "I", "TP"],
    damageTags: ["P", "S", "Y"],
  ...
  },
  {
    ...
    reprintedAs: ["Clockwork Iron Cobra|MPMM"],
    size: ["M"],
    type: "construct",
    alignment: ["U"],
    ac: [13],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell acid splash} (17th level)", "{@spell detect magic}"],
        daily: {
          "3e": [
            "{@spell blight}",
            "{@spell contagion}",
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Juiblex's weapon attacks are magical."],
      },
      {
        name: "Regeneration",
        entries: [
    ...
    legendary: [
      {
        name: "Acid Splash",
        entries: ["Juiblex casts {@spell acid splash}."],
      },
      {
        name: "Attack",
  ...
  },
  {
    ...
    source: "MTF",
    page: 212,
    reprintedAs: ["Kruthik Hive Lord|MPMM"],
    size: ["L"],
    type: "monstrosity",
    alignment: ["U"],
    ac: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell plane shift} (self only)"],
        ability: "int",
      },
    ],
    trait: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The marut makes two slam attacks."],
      },
      {
        name: "Unerring Slam",
        entries: [
    ...
    traitTags: ["Immutable Form", "Legendary Resistances", "Magic Resistance"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["XX"],
    damageTags: ["O", "R"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Devil's Sight",
        entries: ["Magical darkness doesn't impede the merregon's darkvision."],
      },
      {
        name: "Magic Resistance",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The merrenoloth's weapon attacks are magical."],
      },
      {
        name: "Teleport",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell flame strike}", "{@spell symbol} (stunning only)"],
        },
        ability: "cha",
      },
    ],
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Moloch's weapon attacks are magical."],
      },
      {
        name: "Regeneration",
        entries: [
    ...
    legendary: [
      {
        name: "Stinking Cloud",
        entries: ["Moloch casts {@spell stinking cloud}."],
      },
      {
        name: "Teleport",
        entries: ["Moloch uses his Teleport action."],
      },
      {
        name: "Whip",
        entries: ["Moloch makes one attack with his whip."],
      },
    ],
    soundClip: {
      type: "internal",
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The molydeus's weapon attacks are magical."],
      },
    ],
    action: [
      {
    ...
    legendary: [
      ...
      {
        name: "Move",
        entries: ["The molydeus moves without provoking opportunity attacks."],
      },
      {
        name: "Cast a Spell",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The nabassu's weapon attacks are magical."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          6: {
            slots: 1,
            spells: ["{@spell circle of death}", "{@spell disintegrate}"],
          },
          7: {
            slots: 1,
            spells: ["{@spell etherealness}", "{@spell prismatic spray}"],
          },
          8: {
            slots: 1,
            spells: ["{@spell feeblemind}"],
          },
        },
        ability: "int",
      },
    ...
    languageTags: ["C", "X"],
    damageTags: ["B"],
    damageTagsSpell: ["A", "C", "F", "I", "L", "N", "O", "Y"],
    spellcastingTags: ["CW"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 126,
    reprintedAs: ["Clockwork Oaken Bolter|MPMM"],
    size: ["M"],
    type: "construct",
    alignment: ["U"],
    ac: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 220,
    reprintedAs: ["Ogre Battering Ram|MPMM"],
    size: ["L"],
    type: "giant",
    alignment: ["C", "E"],
    ac: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 220,
    reprintedAs: ["Ogre Bolt Launcher|MPMM"],
    size: ["L"],
    type: "giant",
    alignment: ["C", "E"],
    ac: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 221,
    reprintedAs: ["Ogre Chain Brute|MPMM"],
    size: ["L"],
    type: "giant",
    alignment: ["C", "E"],
    ac: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The oinoloth's weapon attacks are magical."],
      },
    ],
    action: [
      {
    ...
    languageTags: ["AB", "I", "TP"],
    damageTags: ["N", "S"],
    damageTagsSpell: ["C", "F", "Y"],
    spellcastingTags: ["I"],
    miscTags: ["HPR", "MW"],
    conditionInflict: ["charmed", "exhaustion", "poisoned", "restrained"],
    conditionInflictSpell: ["invisible"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell chill touch} (17th level)", "{@spell detect magic}"],
        daily: {
          1: ["{@spell time stop}"],
          "3e": ["{@spell create undead}", "{@spell dispel magic}"],
        },
        ability: "cha",
      },
    ],
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Orcus's weapon attacks are magical."],
      },
      {
        name: "Master of Undeath",
        entries: [
          "When Orcus casts {@spell animate dead} or {@spell create undead}, he chooses the level at which the spell is cast, and the creatures created by the spells remain under his control indefinitely. Additionally, he can cast {@spell create undead} even when it isn't night.",
        ],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["Orcus makes two Wand of Orcus attacks."],
      },
      {
        name: "Wand of Orcus",
        entries: [
    ...
    legendary: [
      {
        name: "Tail",
        entries: ["Orcus makes one tail attack."],
      },
      {
        name: "A Taste of Undeath",
        entries: ["Orcus casts {@spell chill touch} (17th level)."],
      },
      {
  ...
  },
  {
    ...
    reprintedAs: ["Sacred Statue|MPMM"],
    size: ["L"],
    type: "construct",
    alignment: [
      {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The statue makes two slam attacks."],
      },
      {
        name: "Slam",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 225,
    reprintedAs: ["Shadar-kai Shadow Dancer|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The shadow dancer makes three spiked chain attacks."],
      },
      {
        name: "Spiked Chain",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Contamination",
        entries: [
          "The sibriex emits an aura of corruption 30 feet in every direction. Plants that aren't creatures wither in the aura, and the ground in it is {@quickref difficult terrain||3} for other creatures. Any creature that starts its turn in the aura must succeed on a {@dc 20} Constitution saving throw or take 14 ({@damage 4d6}) poison damage. A creature that succeeds on the save is immune to this sibriex's Contamination for 24 hours.",
        ],
      },
      {
        name: "Legendary Resistance (3/Day)",
    ...
    legendary: [
      {
        name: "Cast a Spell",
        entries: ["The sibriex casts a spell."],
      },
      {
        name: "Spray Bile",
    ...
    conditionInflictSpell: ["charmed", "paralyzed", "prone"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 3,
            spells: ["{@spell mirror image}", "{@spell scorching ray}"],
          },
          3: {
            slots: 3,
            spells: ["{@spell fear}", "{@spell haste}"],
          },
          4: {
            slots: 3,
            spells: ["{@spell dimension door}", "{@spell ice storm}"],
          },
          5: {
            slots: 2,
            spells: ["{@spell cloudkill}", "{@spell cone of cold}"],
          },
          6: {
            slots: 1,
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The skull lord makes three bone staff attacks."],
      },
      {
        name: "Bone Staff",
        entries: [
    ...
    legendary: [
      {
        ...
        entries: ["The skull lord makes a bone staff attack."],
      },
      {
        name: "Cantrip",
        entries: ["The skull lord casts a cantrip."],
      },
      {
        name: "Move",
        entries: [
    ...
    languageTags: ["LF"],
    damageTags: ["B", "N"],
    damageTagsSpell: ["B", "C", "F", "I", "L", "N", "O", "T"],
    spellcastingTags: ["CS"],
    miscTags: ["MW"],
    hasToken: true,
    hasFluff: true,
  ...
  },
  {
    ...
    source: "MTF",
    page: 226,
    reprintedAs: ["Shadar-kai Soul Monger|MPMM"],
    size: ["M"],
    type: {
      type: "humanoid",
      tags: ["elf"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The soul monger makes two phantasmal dagger attacks."],
      },
      {
  ...
  },
  {
    ...
    source: "MTF",
    page: 196,
    reprintedAs: ["Spring Eladrin|MPMM"],
    size: ["M"],
    type: {
      type: "fey",
      tags: ["elf"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 234,
    reprintedAs: ["Star Spawn Grue|MPMM"],
    size: ["S"],
    type: "aberration",
    alignment: ["L", "E"],
    ac: [11],
  ...
  },
  {
    ...
    source: "MTF",
    page: 234,
    reprintedAs: ["Star Spawn Hulk|MPMM"],
    size: ["L"],
    type: "aberration",
    alignment: ["C", "E"],
    ac: [
  ...
  },
  {
    ...
    reprintedAs: ["Star Spawn Larva Mage|MPMM"],
    size: ["M"],
    type: "aberration",
    alignment: ["C", "E"],
    ac: [
    ...
    spellcasting: [
      {
        ...
        daily: {
          1: ["{@spell circle of death}"],
          3: ["{@spell dominate monster}"],
        },
        footerEntries: ["*3 beams, +3 bonus to each damage roll"],
        ability: "cha",
      },
    ],
    trait: [
    ...
    legendary: [
      {
        ...
        entries: ["The larva mage casts one cantrip."],
      },
      {
        name: "Slam (Costs 2 Actions)",
        entries: ["The larva mage makes one slam attack."],
      },
      {
  ...
  },
  {
    ...
    reprintedAs: ["Star Spawn Mangler|MPMM"],
    size: ["M"],
    type: "aberration",
    alignment: ["C", "E"],
    ac: [14],
  ...
  },
  {
    ...
    source: "MTF",
    page: 236,
    reprintedAs: ["Star Spawn Seer|MPMM"],
    size: ["M"],
    type: "aberration",
    alignment: ["L", "E"],
    ac: [
    ...
    trait: [
      {
        ...
        entries: [
          "The seer can move through other creatures and objects as if they were {@quickref difficult terrain||3}. Each creature it moves through takes 5 ({@damage 1d10}) psychic damage; no creature can take this damage more than once per turn. The seer takes 5 ({@damage 1d10}) force damage if it ends its turn inside an object.",
        ],
      },
    ],
    action: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 239,
    reprintedAs: ["Steel Predator|MPMM"],
    size: ["L"],
    type: "construct",
    alignment: ["L", "E"],
    ac: [
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The steel predator's weapon attacks are magical."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    source: "MTF",
    page: 126,
    reprintedAs: ["Clockwork Stone Defender|MPMM"],
    size: ["M"],
    type: "construct",
    alignment: ["U"],
    ac: [
    ...
    traitTags: ["False Appearance", "Magic Resistance"],
    senseTags: ["D"],
    languageTags: ["CS"],
    damageTags: ["B"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 196,
    reprintedAs: ["Summer Eladrin|MPMM"],
    size: ["M"],
    type: {
      type: "fey",
      tags: ["elf"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The eladrin makes two weapon attacks."],
      },
      {
        name: "Longsword",
        entries: [
  ...
  },
  {
    ...
    reprintedAs: ["Sword Wraith Commander|MPMM"],
    size: ["M"],
    type: "undead",
    alignment: ["L", "E"],
    ac: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The sword wraith makes two weapon attacks."],
      },
      {
        name: "Longsword",
        entries: [
  ...
  },
  {
    ...
    reprintedAs: ["Sword Wraith Warrior|MPMM"],
    size: ["M"],
    type: "undead",
    alignment: ["L", "E"],
    ac: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 231,
    reprintedAs: ["Angry Sorrowsworn|MPMM"],
    size: ["M"],
    type: "monstrosity",
    alignment: ["L", "E"],
    ac: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The Angry makes two hook attacks."],
      },
      {
        name: "Hook",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 233,
    reprintedAs: ["Lost Sorrowsworn|MPMM"],
    size: ["M"],
    type: "monstrosity",
    alignment: ["L", "E"],
    ac: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The Lost makes two arm spike attacks."],
      },
      {
        name: "Arm Spike",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 233,
    reprintedAs: ["Wretched Sorrowsworn|MPMM"],
    size: ["S"],
    type: "monstrosity",
    alignment: ["L", "E"],
    ac: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Titivilus's weapon attacks are magical."],
      },
      {
        name: "Regeneration",
        entries: [
    ...
    legendary: [
      ...
      {
        name: "Teleport",
        entries: ["Titivilus uses his Teleport action."],
      },
    ],
    soundClip: {
      type: "internal",
  ...
  },
  {
    ...
    attachedItems: ["light crossbow|phb", "quarterstaff|phb"],
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 3,
            spells: ["{@spell darkvision}", "{@spell hold person}"],
          },
        },
        ability: "wis",
      },
  ...
  },
  {
    ...
    reprintedAs: ["Vampiric Mist|MPMM"],
    size: ["M"],
    type: "undead",
    alignment: ["C", "E"],
    ac: [13],
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Undertow",
        entries: [
          "As a bonus action when the wastrilith is underwater, it can cause all water within 60 feet of it to be {@quickref difficult terrain||3} for other creatures until the start of its next turn.",
        ],
      },
    ],
    action: [
  ...
  },
  {
    ...
    reprintedAs: ["Water Elemental Myrmidon|MPMM"],
    size: ["M"],
    type: "elemental",
    alignment: ["N"],
    ac: [
  ...
  },
  {
    ...
    reprintedAs: ["White Abishai|MPMM"],
    size: ["M"],
    type: {
      type: "fiend",
      tags: ["devil"],
  ...
  },
  {
    ...
    source: "MTF",
    page: 197,
    reprintedAs: ["Winter Eladrin|MPMM"],
    size: ["M"],
    type: {
      type: "fey",
      tags: ["elf"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell fog cloud}", "{@spell gust of wind}"],
        daily: {
          "1e": ["{@spell cone of cold}", "{@spell ice storm}"],
        },
        ability: "int",
      },
    ],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The yagnoloth's weapon attacks are magical."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Yeenoghu's weapon attacks are magical."],
      },
      {
        name: "Rampage",
        entries: [
  ...
  },
  {
    ...
    source: "MTF",
    page: 211,
    reprintedAs: ["Young Kruthik|MPMM"],
    size: ["S"],
    type: "monstrosity",
    alignment: ["U"],
    ac: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["The zaratan's weapon attacks are magical."],
      },
      {
        name: "Siege Monster",
        entries: [
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["The zaratan uses Spit Rock."],
      },
      {
    ...
    traitTags: ["Legendary Resistances", "Magic Weapons", "Siege Monster"],
    senseTags: ["D", "T"],
    actionTags: ["Multiattack"],
    damageTags: ["B", "P", "T"],
    miscTags: ["AOE", "MW", "RCH", "RW"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Devil's Sight",
        entries: ["Magical darkness doesn't impede Zariel's darkvision."],
      },
      {
        name: "Magic Weapons",
        entries: [
    ...
    legendary: [
      ...
      {
        name: "Teleport",
        entries: ["Zariel uses her Teleport action."],
      },
    ],
    legendaryGroup: {
      name: "Zariel",
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Zuggtmoy's weapon attacks are magical."],
      },
    ],
    action: [
      {

export const lmopMonsters = [
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          1: {
            slots: 4,
            spells: ["{@spell charm person}", "{@spell magic missile}"],
          },
          2: {
            slots: 3,
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell darkness}", "{@spell faerie fire} (save {@dc 12})"],
        },
      },
      {
        name: "Spellcasting",
    ...
    trait: [
      {
        ...
        entries: ["Nezznar has a {@item spider staff|lmop}."],
      },
      {
        name: "Fey Ancestry",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The ruffian makes two melee attacks."],
      },
      {
        name: "Shortsword",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Sildar makes two melee attacks."],
      },
      {
        name: "Longsword",
        entries: [

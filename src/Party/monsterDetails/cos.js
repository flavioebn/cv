export const cosMonsters = [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          5: {
            slots: 2,
            spells: ["{@spell cloudkill}", "{@spell geas}", "{@spell scrying}"],
          },
          6: {
            slots: 1,
            spells: ["{@spell programmed illusion}", "{@spell true seeing}"],
          },
          7: {
            slots: 1,
            spells: ["{@spell finger of death}", "{@spell mirage arcane}"],
          },
          8: {
            slots: 1,
            spells: ["{@spell power word stun}"],
          },
        },
        ability: "int",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Baba Lysaga makes three attacks with her quarterstaff."],
      },
      {
        name: "Quarterstaff",
        entries: [
    ...
    languageTags: ["AB", "C", "D", "DR", "GI"],
    damageTags: ["B"],
    damageTagsSpell: ["A", "B", "F", "I", "L", "N", "O", "Y"],
    spellcastingTags: ["CW"],
    miscTags: ["MW"],
    hasToken: true,
    hasFluff: true,
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: [
          "The hut is {@condition incapacitated} while the magic gem that animates it is in the area of an {@spell antimagic field}. If targeted by {@spell dispel magic}, the hut must succeed on a Constitution saving throw against the caster's spell save DC or fall {@condition unconscious} for 1 minute.",
        ],
      },
      {
        name: "Siege Monster",
        entries: ["The hut deals double damage to objects and structures."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Antimagic Susceptibility", "Siege Monster"],
    senseTags: ["B"],
    actionTags: ["Multiattack"],
    damageTags: ["B"],
    miscTags: ["MW", "RCH", "RW"],
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 2,
            spells: ["{@spell alter self}", "{@spell invisibility}"],
          },
        },
        ability: "int",
      },
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Antimagic Susceptibility",
        entries: [
          "The broom is {@condition incapacitated} while in the area of an {@spell antimagic field}. If targeted by {@spell dispel magic}, the broom must succeed on a Constitution saving throw against the caster's spell save DC or fall {@condition unconscious} for 1 minute.",
        ],
      },
      {
  ...
  },
  {
    ...
    ac: [
      {
        ac: 17,
        from: ["{@item +1 studded leather armor}"],
      },
    ],
    hp: {
      average: 82,
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          4: {
            slots: 1,
            spells: ["{@spell greater invisibility}"],
          },
        },
        ability: "int",
      },
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Antimagic Susceptibility",
        entries: [
          "The portrait is {@condition incapacitated} while in the area of an {@spell antimagic field}. If targeted by {@spell dispel magic}, the portrait must succeed on a Constitution saving throw against the caster's spell save DC or become {@condition unconscious} for 1 minute.",
        ],
      },
      {
        name: "False Appearance",
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Izek makes two attacks with his battleaxe."],
      },
      {
        name: "Battleaxe",
        entries: [
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          3: {
            slots: 2,
            spells: ["{@spell animate dead}", "{@spell create food and water}"],
          },
        },
        ability: "wis",
      },
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          5: {
            slots: 2,
            spells: ["{@spell greater restoration}", "{@spell raise dead}"],
          },
          6: {
            slots: 1,
            spells: [
          ...
          7: {
            slots: 1,
            spells: ["{@spell fire storm}", "{@spell regenerate}"],
          },
          8: {
            slots: 1,
    ...
    action: [
      ...
      },
      {
        name: "Curse (Recharges after a Long Rest)",
        entries: [
          "Madam Eva targets one creature that she can see within 30 feet of her. The target must succeed on a {@dc 17} Wisdom saving throw or be cursed. While cursed, the target is {@condition blinded} and {@condition deafened}. The curse lasts until ended with a {@spell greater restoration} spell, a {@spell remove curse} spell, or similar magic. When the curse ends, Madam Eva takes {@dice 5d6} psychic damage.",
        ],
      },
      {
        name: "Evil Eye (Recharges after a Short or Long Rest)",
    ...
    attachedItems: ["dagger|phb"],
    languageTags: ["AB", "C", "E", "I"],
    damageTags: ["P"],
    damageTagsSpell: ["B", "F", "N", "O", "R"],
    spellcastingTags: ["CC"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: [
          "The phantom warrior can move through other creatures and objects as if they were {@quickref difficult terrain||3}. It takes 5 ({@damage 1d10}) force damage if it ends its turn inside an object.",
        ],
      },
      {
            ...
            items: [
              {
                ...
                entries: [
                  "{@atk rw} {@hit 2} to hit, range 150/600 ft., one target. {@h}4 ({@damage 1d8}) force damage.",
                ],
              },
            ],
          },
  ...
  },
  {
    ...
    attachedItems: ["club|phb", "dart|phb"],
    traitTags: ["Ambusher"],
    languageTags: ["C"],
    damageTags: ["B", "P"],
    miscTags: ["MW", "RW", "THW"],
    ...
    spellcasting: [
      {
        ...
        daily: {
          1: ["{@spell magic weapon}", "{@spell nondetection}"],
          3: ["{@spell misty step}", "{@spell phantom steed}"],
        },
        ability: "int",
      },
    ],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          5: {
            slots: 1,
            spells: ["{@spell dispel evil and good}"],
          },
        },
        ability: "wis",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Rictavio makes two attacks with his sword cane."],
      },
      {
        name: "Sword Cane",
        entries: [
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 3,
            spells: ["{@spell branding smite}", "{@spell magic weapon}"],
          },
          3: {
            slots: 3,
          ...
          4: {
            slots: 2,
            spells: ["{@spell staggering smite}"],
          },
        },
        ability: "wis",
      },
    ],
    damageTagsSpell: ["R", "T", "Y"],
    spellcastingTags: ["CP"],
    hasToken: true,
    hasFluffImages: true,
  },
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          4: {
            slots: 3,
            spells: ["{@spell greater invisibility}", "{@spell stoneskin}"],
          },
          5: {
            slots: 1,
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          5: {
            slots: 1,
            spells: ["{@spell animate objects}", "{@spell scrying}"],
          },
        },
        ability: "int",
      },
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["Strahd makes one bite attack."],
      },
    ],
    legendaryGroup: {
      name: "Strahd von Zarovich",
    ...
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["AB", "C", "DR", "E", "GI", "I"],
    damageTags: ["N", "P", "S"],
    damageTagsSpell: ["B", "C", "F", "N", "P", "S"],
    spellcastingTags: ["CW"],
    miscTags: ["HPR", "MW"],
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          7: {
            slots: 1,
            spells: ["{@spell Mordenkainen's magnificent mansion}"],
          },
          8: {
            slots: 1,
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Siege Monster",
        entries: ["The blight deals double damage to objects and structures."],
      },
    ],
    action: [
      {
    ...
    bonus: [
      {
        name: "Bite",
        entries: [
          "{@atk mw} {@hit 9} to hit, reach 5 ft., one creature {@condition grappled} by the blight. {@h}19 ({@damage 3d8 + 6}) piercing damage.",
        ],
      },
    ],
    traitTags: ["False Appearance", "Siege Monster"],
    senseTags: ["B"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "DU"],
    damageTags: ["B", "P", "S"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Turn Immunity",
        entries: ["Vladimir is immune to effects that turn undead."],
      },
      {
    ...
    attachedItems: ["+2 greatsword|dmg"],
    traitTags: ["Regeneration", "Rejuvenation", "Turn Immunity"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "DR"],
    damageTags: ["B", "S"],

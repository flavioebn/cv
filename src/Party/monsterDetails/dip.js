export const dipMonsters = [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Don-Jon makes three melee attacks."],
      },
      {
        name: "Dagger",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Falcon makes three melee attacks or two ranged attacks."],
      },
      {
        name: "Longsword",
        entries: [

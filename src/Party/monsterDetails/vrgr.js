export const vrgrMonsters = [
  {
    ...
    passive: 12,
    vulnerable: ["poison"],
    conditionImmune: ["blinded", "charmed", "frightened", "prone"],
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The plant doesn't require sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The plant makes three Vine Lash attacks."],
      },
      {
        name: "Vine Lash",
        entries: [
    ...
    damageTags: ["A", "S"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["grappled", "restrained", "stunned"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The boneless doesn't require sleep."],
      },
    ],
    action: [
      {
    ...
    damageTags: ["B"],
    miscTags: ["MW"],
    conditionInflict: ["blinded", "grappled"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    passive: 10,
    immune: ["poison"],
    conditionImmune: ["exhaustion", "paralyzed", "poisoned", "prone"],
    ...
    spellcasting: [
      {
        ...
        daily: {
          "3e": ["{@spell charm person}", "{@spell hold person}"],
          "1e": [
            "{@spell compulsion}",
            "{@spell hold monster}",
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The brain doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The dullahan doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The dullahan makes two attacks."],
      },
      {
        name: "Battleaxe",
        entries: [
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["The dullahan makes one attack."],
      },
      {
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Elise's weapon attacks are magical."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["Elise makes two slam attacks."],
      },
      {
        name: "Slam",
        entries: [
  ...
  },
  {
    ...
    senses: ["truesight 120 ft."],
    passive: 23,
    resist: ["acid", "force", "necrotic", "psychic"],
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The emissary doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The emissary makes three attacks."],
      },
      {
        name: "Lashing Maw",
        entries: [
    ...
    reaction: [
      {
        ...
        entries: [
          "Immediately after a creature within 30 feet of the gremishka casts a spell, the gremishka can spontaneously react to the magic. Roll a {@dice d6} to determine the effect:",
          {
            ...
            name: "1-2",
            entry:
              "The gremishka emanates magical energy. Each creature within 30 feet of the gremishka must succeed on a {@dc 10} Constitution saving throw or take 3 ({@damage 1d6}) force damage.",
          },
          {
            type: "item",
            name: "3-4",
            entry:
              "The gremishka surges with magical energy and regains 3 ({@dice 1d6}) hit points.",
          },
          {
            type: "item",
            name: "5-6",
            entry:
              "The gremishka explodes and dies, and one swarm of gremishkas instantly appears in the space where this gremishka died. The swarm uses the gremishka's initiative.",
          },
        ],
      },
    ],
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell mass suggestion}", "{@spell modify memory}"],
        },
        ability: "cha",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell Otiluke's resilient sphere}", "{@spell telekinesis}"],
        },
        ability: "int",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The inquisitor attacks twice."],
      },
      {
        name: "Force Bolt",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        ...
        entries: ["The AC of Isolde includes her Charisma bonus."],
      },
      {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Isolde makes two melee attacks or uses its Fire Ray twice."],
      },
      {
        name: "Nepenthe",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The jiangshi doesn't require air."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    legendary: [
      {
        name: "Psychic Orb",
        entries: ["The emissary makes a Psychic Orb attack."],
      },
      {
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The necrichor doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The necrichor makes two attacks."],
      },
      {
        name: "Pseudopod",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The nosferatu doesn't require air."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The podling doesn't require sleep."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The priest attacks twice."],
      },
      {
        name: "Soul Blade",
        entries: [
        ...
        spellcasting: [
          {
            ...
            daily: {
              "1e": ["{@spell animate dead}", "{@spell create undead}"],
            },
            ability: "int",
            displayAs: "action",
          },
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The juggernaut doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["The juggernaut recharges Deadly Shaping and uses it."],
      },
    ],
    traitTags: ["Legendary Resistances", "Regeneration", "Unusual Nature"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["CS", "XX"],
    damageTags: ["B", "N", "P", "S"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The slasher makes two Slasher's Knife attacks."],
      },
      {
  ...
  },
  {
    ...
    traitTags: ["Amorphous", "Keen Senses", "Regeneration"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The horror makes two Limbs attacks."],
      },
      {
        name: "Limbs",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The mind flayer doesn't require air, food, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Spider Climb", "Sunlight Sensitivity", "Unusual Nature"],
    senseTags: ["SD"],
    actionTags: ["Multiattack", "Tentacles"],
    languageTags: ["TP"],
    damageTags: ["N", "P", "S", "Y"],
    miscTags: ["AOE", "MW"],
    conditionInflict: ["exhaustion", "grappled", "incapacitated"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    traitTags: ["Regeneration", "Shapechanger"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "CS"],
    damageTags: ["P"],
    miscTags: ["MW", "RNG", "RW"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The zombie makes two Slam attacks."],
      },
      {
        name: "Slam",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The plague spreader makes two Slam attacks."],
      },
      {
        name: "Slam",
        entries: [

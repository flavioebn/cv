export const rotMonsters = [
  ...
  },
  {
      ...
      _mod: {
        trait: {
          ...
          items: {
            ...
            entries: ["The troll can breathe underwater."],
          },
        },
      },
    },
    ...
    resist: ["cold"],
    traitTags: ["Keen Senses", "Regeneration", "Water Breathing"],
    hasToken: true,
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          4: {
            slots: 3,
            spells: ["{@spell fire shield}", "{@spell greater invisibility}"],
          },
          5: {
            slots: 2,
            spells: ["{@spell cloudkill}", "{@spell wall of stone}"],
          },
        },
        ability: "int",
      },
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: [
          "Once per turn, if the dragonfang makes a weapon attack with advantage on the attack roll and hits, the target takes an extra 10 ({@dice 3d6}) damage.",
        ],
      },
      {
        name: "Limited Flight",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The Dragonfang attacks twice with its shortsword."],
      },
      {
        name: "Shortsword",
        entries: [
          "{@atk mw} {@hit 6} to hit, reach 5 ft., one target. {@h}6 ({@damage 1d6 + 3}) piercing damage plus 7 ({@dice 2d6}) damage of the type to which the dragonfang has resistance.",
        ],
      },
      {
        name: "Orb of Dragon's Breath (2/Day)",
        entries: [
          "{@atk rs} {@hit 5} to hit, range 50 ft., one target. {@h}22 ({@dice 5d8}) damage of the type to which the dragonfang has damage resistance.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Fanatic Advantage",
        entries: [
          "Once per turn, if the dragonsoul makes a weapon attack with advantage on the attack roll and hits, the target takes an extra 10 ({@dice 3d6}) damage.",
        ],
      },
      {
        name: "Limited Flight",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The Dragonsoul attacks twice with its shortsword."],
      },
      {
        name: "Shortsword",
        entries: [
          "{@atk mw} {@hit 7} to hit, reach 5 ft., one target. {@h}6 ({@damage 1d6 + 3}) piercing damage plus 10 ({@dice 3d6}) damage of the type to which the dragonsoul has resistance.",
        ],
      },
      {
        name: "Orb of Dragon's Breath (3/Day)",
        entries: [
          "{@atk rs} {@hit 7} to hit, range 90 ft., one target. {@h}27 ({@dice 6d8}) damage of the type to which the dragonsoul has damage resistance.",
        ],
      },
    ],
    attachedItems: ["shortsword|phb"],
  ...
  },
  {
        ...
        trait: {
          ...
          items: [
            ...
            },
            {
              ...
              entries: ["Galvan has the {@item Blue Dragon Mask|RoTOS}."],
            },
            {
    ...
    immune: ["lightning"],
    traitTags: ["Legendary Resistances", "Pack Tactics"],
    senseTags: ["D"],
    hasToken: true,
  },
  {
    ...
    senseTags: ["B", "D"],
    actionTags: ["Breath Weapon", "Multiattack", "Parry"],
    languageTags: ["C", "DR", "X"],
    damageTags: ["B", "L", "P"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The toad can breathe air or water."],
      },
      {
        name: "Cold Aura",
        entries: [
      ...
      _mod: {
        trait: {
          ...
          items: {
            name: "5etools Note",
            entries: [
              "Maccath the Crimson is presented in {@adventure The Rise of Tiamat|RoT} as a female tiefling sorcerer and member of the Arcane Brotherhood. The {@creature mage} stat block, modified with tiefling racial traits, has been provided here for ease of use.",
            ],
          },
        },
      },
  ...
  },
  {
    ...
    trait: [
      {
        name: "Draconic Majesty",
        entries: ["Neronvain adds his Charisma bonus to his AC (included)."],
      },
      {
        name: "Fey Ancestry",
        entries: ["Magic can't put Neronvain to sleep."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    trait: [
      {
        name: "Special Equipment",
        entries: ["Severin has the {@item Mask of the Dragon Queen|rot}."],
      },
      {
        name: "Draconic Majesty",
        entries: ["Severin adds his Charisma bonus to his AC (included)."],
      },
      {
        name: "Ignite Enemy",
        entries: [
    ...
    legendary: [
      ...
      {
        name: "Attack",
        entries: ["Severin makes one attack."],
      },
      {
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Magic Weapons",
        entries: ["Tiamat's weapon attacks are magical."],
      },
      {
        name: "Multiple Heads",
        entries: [
      ...
      {
        name: "Regeneration",
        entries: ["Tiamat regains 30 hit points at the start of her turn."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Legendary Resistances", "Magic Weapons", "Regeneration"],
    senseTags: ["SD", "U"],
    actionTags: ["Frightful Presence", "Multiattack"],
    languageTags: ["C", "DR", "I"],
    damageTags: ["A", "C", "F", "I", "L", "P", "S"],
    spellcastingTags: ["I"],
    miscTags: ["AOE", "MW", "RCH"],
    conditionInflict: ["frightened"],
    conditionInflictSpell: ["blinded", "deafened", "stunned"],
    hasToken: true,
    hasFluffImages: true,
  },
  {

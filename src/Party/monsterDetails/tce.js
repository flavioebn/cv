export const tceMonsters = [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The beast can breathe both air and water."],
      },
      {
        name: "Primal Bond",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        ...
        entries: ["The beast can breathe only underwater."],
      },
      {
        name: "Flyby (Air Only)",
        entries: [
    ...
    attachedItems: ["maul|phb"],
    traitTags: ["Flyby", "Pack Tactics", "Water Breathing"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    damageTags: ["P"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    conditionImmune: ["charmed", "exhaustion", "poisoned", "frightened"],
    languages: ["understands the languages you speak"],
    trait: [
      {
        name: "Immutable Form",
          ...
          "The fey magically teleports up to 30 feet to an unoccupied space it can see. Then one of the following effects occurs, based on the fey's chosen mood:",
          {
            ...
            items: [
              ...
              },
              {
                ...
                name: "Mirthful",
                entry:
                  "The fey can force one creature it can see within 10 feet of it to make a Wisdom saving throw against your spell save DC. Unless the save succeeds, the target is {@condition charmed} by you and the fey for 1 minute or until the target takes any damage.",
              },
              {
                type: "item",
                name: "Tricksy",
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: ["Magical darkness doesn't impede the fiend's darkvision."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Death Burst", "Devil's Sight", "Magic Resistance"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The servant doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Magic Resistance", "Regeneration", "Unusual Nature"],
    senseTags: ["B"],
    languageTags: ["CS"],
    damageTags: ["B", "O"],
    miscTags: ["MW", "RCH"],
  ...
  },
  {
    ...
    hp: {
      special:
        "2 + your Intelligence modifier + five times your artificer level (the defender has a number of Hit Dice [d8s] equal to your artificer level)",
    },
    speed: {
      walk: 40,
    },
    ...
    trait: [
      {
        name: "Vigilant",
        entries: [
          "The defender can't be {@quickref Surprise|PHB|3|0|surprised}.",
        ],
      },
    ],
    actionNote: "Requires Your Bonus Action",
  ...
  },
  {
    ...
    conditionImmune: ["exhaustion", "frightened", "paralyzed", "poisoned"],
    languages: ["understands the languages you speak"],
    trait: [
      {

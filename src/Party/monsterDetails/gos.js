export const gosMonsters = [
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The amphisbaena makes two bite attacks."],
      },
      {
        name: "Bite",
        entries: [
          "{6} to hit, reach 5 ft., one target. 6 ( 1d4 + 4}) piercing damage, and the target must make a {11} Constitution saving throw, taking 3 ( 1d6}) poison damage on a failed save, or half as much damage on a successful one.",
        ],
      },
    ],
    altArt: [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The croaker can breathe air and water."],
      },
      {
    ...
    action: [
      {
        name: "Spear",
        entries: [
          "{4} to hit, reach 5 ft. or range 20/60 ft., one target. 5 ( 1d6 + 2}) piercing damage, or 6 ( 1d8 + 2}) piercing damage if used with two hands to make a melee attack.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{4} to hit, reach 5 ft., one target. 5 ( 1d6 + 2}) piercing damage.",
        ],
      },
      {
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The royal can breathe air and water."],
      },
      {
        name: "Brute",
        entries: [
    ...
    action: [
      ...
      },
      {
        name: "Royal Spear",
        entries: [
          "{5} to hit, reach 10 ft. or range 20/60 ft., one target. 10 ( 2d6 + 3}) piercing damage, or 12 ( 2d8 + 3}) piercing damage if used with two hands to make a melee attack. If the target is a Medium or smaller creature, it must succeed on a {13} Strength saving throw or be knocked {prone}.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{5} to hit, reach 5 ft., one target. 6 ( 1d6 + 3}) piercing damage.",
        ],
      },
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The drowned ascetic makes three unarmed strikes."],
      },
      {
        name: "Unarmed Strike",
        entries: [
          '{5} to hit, reach 5 ft., one target. 7 ( 1d8 + 3}) bludgeoning damage, and the target must succeed on a {12} Constitution saving throw or contract {@disease bluerot|GoS} (see the "Bluerot" in notes).',
        ],
      },
    ],
    reaction: [
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Hand Crossbow",
        entries: [
          '{5} to hit, range 30/120 ft., one target. 6 ( 1d6 + 3}) piercing damage plus 3 ( 1d6}) poison damage, and the target must succeed on a {12} Constitution saving throw or contract {@disease bluerot|GoS} (see the "Bluerot" in notes).',
        ],
      },
      {
        name: "Dagger",
        entries: [
          '{5} to hit, reach 5 ft., one target. 5 ( 1d4 + 3}) piercing damage plus 9 ( 2d8}) poison damage, and the target must succeed on a {12} Constitution saving throw or contract {@disease bluerot|GoS} (see the "Bluerot" in notes).',
        ],
      },
      {
        name: "Reveal (1/Day)",
        entries: [
          "The drowned assassin removes its mask, revealing its rotting face. Each creature of the assassin's choice within 30 feet of it that can see the assassin must succeed on a {13} Wisdom saving throw or be {frightened} until the end of its next turn.",
        ],
      },
    ],
    attachedItems: ["dagger|phb", "hand crossbow|phb"],
    traitTags: ["Undead Fortitude"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["CS", "LF"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The drowned blade makes two rusted longsword attacks."],
      },
      {
        name: "Rusted Longsword",
        entries: [
          '{5} to hit, reach 5 ft., one target. 7 ( 1d8 + 3}) slashing damage, and the target must succeed on a {12} Constitution saving throw or contract {@disease bluerot|GoS} (see the "Bluerot" in notes).',
        ],
      },
    ],
    traitTags: ["Undead Fortitude"],
    ...
    action: [
      {
        name: "Multiattack",
        entries: [
          "The drowned master makes two attacks: one with its Greatsword and one with its Life-Draining Tentacle.",
        ],
      },
      {
        name: "Greatsword",
        entries: [
          '{7} to hit, reach 5 ft., one target. 10 ( 2d6 + 3}) slashing damage plus 14 ( 4d6}) cold damage, and the target must succeed on a {12} Constitution saving throw or contract {@disease bluerot|GoS} (see the "Bluerot" in notes).',
        ],
      },
      {
        name: "Life-Draining Tentacle",
        entries: [
          '{7} to hit, reach 15 ft., one target. 10 ( 2d6 + 3}) necrotic damage. The target must succeed on a {15} Constitution saving throw or have its hit point maximum reduced by an amount equal to the damage taken. The target dies if this effect reduces its hit point maximum to 0. This reduction lasts until the target finishes a Long Rest. On a failed save, the target also contracts bluerot (see the "Bluerot" in notes).',
        ],
      },
      {
        name: "Necrotic Ink {@recharge 5}",
        entries: [
          'The drowned master discharges foul ink in front of itself in a 30-foot cone. Each creature caught in the ink must make a {15} Constitution saving throw, taking 27 ( 6d8}) necrotic damage on a failed save or half as much damage on a successful one. A creature that fails this saving throw is {blinded} until the end of its next turn and contracts bluerot (see the "Bluerot" in notes).',
        ],
      },
    ],
    ...
    action: [
      {
        name: "Bite",
        entries: [
          '{5} to hit, reach 5 ft., one target. 8 ( 2d4 + 3}) piercing damage, and the target must succeed on a {12} Constitution saving throw or be {stunned} until the end of its next turn. On a failed save, the target begins to hallucinate and is afflicted with a {@table short-term madness|DMG} effect (determined randomly or by the DM; see "Madness" in chapter 8 of the {@book Dungeon Master\'s Guide|dmg|8|madness}). The effect lasts 10 minutes.',
        ],
      },
    ],
    senseTags: ["B"],
    ...
    action: [
      {
        name: "Bite",
        entries: [
          "{4} to hit, reach 5 ft., one target. 13 ( 2d10 + 2}) piercing damage.",
        ],
      },
    ],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The matriarch makes two claws attacks."],
      },
      {
        name: "Claws",
        entries: [
          "{6} to hit, reach 5 ft., one target. 13 ( 3d6 + 3}) slashing damage.",
        ],
      },
      {
        name: "Fleeting Form",
      ...
      },
      {
        name: "Luring Song",
        entries: [
          "The matriarch sings a magical melody. Every humanoid and giant within 300 feet of the matriarch that can hear the song must succeed on a {14} Wisdom saving throw or be {charmed} until the song ends. The matriarch must take a bonus action on its subsequent turns to continue singing. It can stop singing at any time. The song ends if the matriarch is {incapacitated}.",
      ...
      },
      {
        ...
        entries: [
          "The matriarch projects a vision into the minds of creatures within 30 feet of it that aren't constructs or undead, showing each creature achieving whatever it most desires. An affected creature must succeed on a {14} Wisdom saving throw or drop whatever it is holding and become {paralyzed} until the end of its next turn.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: [
          "The kraken ignores {@quickref difficult terrain||3}, and magical effects can't reduce its speed or cause it to be {restrained}. It can spend 5 feet of movement to escape from nonmagical restraints or being {grappled}.",
        ],
      },
    ],
    action: [
      ...
      },
      {
        name: "Bite",
        entries: [
          "{12} to hit, reach 5 ft., one target. 20 ( 3d8 + 7}) piercing damage. If the target is a Medium or smaller creature {grappled} by the kraken, that creature is swallowed and the grapple ends. While swallowed, the creature is {blinded} and {restrained}, it has total cover against attacks and other effects outside the kraken, and it takes 21 ( 6d6}) acid damage at the start of each of the kraken's turns. One Medium or two smaller creatures can be swallowed at the same time.",
          "If the kraken takes 35 damage or more on a single turn from a creature inside it, the kraken must succeed on a {23} Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, which fall {prone} in spaces within 10 feet of the kraken. If the kraken dies, a swallowed creature is no longer {restrained} by it and can escape from the corpse using 10 feet of movement, exiting {prone}.",
        ],
      },
      {
        name: "Tentacle",
        entries: [
          "{12} to hit, reach 20 ft., one target. 17 ( 3d6 + 7}) bludgeoning damage, and the target is {grappled} (escape {20}). Until the grapple ends, the target is {restrained}. The kraken has ten tentacles, each of which can grapple one target.",
        ],
      },
      {
        name: "Fling",
      ...
      },
      {
        ...
        entries: [
          "The kraken magically create a bolt of lightning, which can strike a target the kraken can see within 90 feet of it. The target must make a {18} Dexterity saving throw, taking 22 ( 4d10}) lightning damage on a failed save, or half as much damage on a successful one.",
        ],
      },
    ],
    legendary: [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The koalinth can breathe air and water."],
      },
      {
        name: "Martial Advantage",
        entries: [
          "Once per turn, the koalinth can deal an extra 7 ({@dice 2d6}) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the koalinth that isn't {incapacitated}.",
        ],
      },
    ],
    action: [
      {
        name: "Trident",
        entries: [
          "{3} to hit, reach 5 ft. or range 20/60 ft., one target. 4 ( 1d6 + 1}) piercing damage, or 5 ( 1d8 + 1}) piercing damage if used with two hands to make a melee attack.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Martial Advantage",
        entries: [
          "Once per turn, the sergeant can deal an extra 7 ({@dice 2d6}) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the sergeant that isn't {incapacitated}.",
        ],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The sergeant makes two melee attacks with its trident."],
      },
      {
        name: "Trident",
        entries: [
      ...
      },
      {
        name: "Hooked Net",
        entries: [
          "{4} to hit, range 10/30 ft., one target. 4 ( 1d4 + 2}) piercing damage, and the target is {restrained}. A creature can use its action to make a {12} Strength check to free itself or another creature in a hooked net, ending the effect on a success. Dealing 5 slashing damage to the net (AC 12) frees the target without harming it and destroys the net.",
        ],
      },
    ],
    reaction: [
      {
        ...
        entries: [
          "Whenever a creature within 30 feet of the sergeant becomes {restrained}, the sergeant can move its speed toward the {restrained} creature. If the sergeant ends its move within reach of the {restrained} creature, it can make a melee attack against it.",
        ],
      },
    ],
    attachedItems: ["trident|phb"],
    ...
    action: [
      {
        name: "Quarterstaff",
        entries: [
          "{6} to hit ({4} to hit with shillelagh), reach 5 ft., one target. 7 ( 1d6 + 4}) bludgeoning damage, 8 ( 1d8 + 4}) bludgeoning damage if wielded with two hands, or 6 ( 1d8 + 2}) bludgeoning damage with {shillelagh}.",
        ],
      },
    ],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        headerEntries: [
          "Kysh's spellcasting ability is Charisma (spell save {12}, {4} to hit with spell attacks). He can cast the following spell, requiring only verbal components:",
        ],
        daily: {
          1: ["{fog cloud}"],
        },
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["Kysh can breathe air and water."],
      },
      {
        name: "Emissary of the Sea",
        entries: [
          "Kysh can communicate simple ideas with amphibious and water-breathing beasts. They understand the meaning of his words, but he cannot understand them in return.",
        ],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["Kysh makes two melee attacks with his spear."],
      },
      {
        name: "Spear",
        entries: [
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Blade",
        entries: [
          "{6} to hit, reach 5 ft., one target. 10 ( 2d6 + 3}) slashing damage.",
        ],
      },
      {
        name: "Hammer",
        entries: [
          "{6} to hit, reach 5 ft., one target. 10 ( 2d6 + 3}) bludgeoning damage, and the target is knocked {prone}.",
        ],
      },
      {
        name: "Whirl {@recharge 5}",
        entries: [
          "The statue can use its action to spin at the waist, targeting creatures of its choice within 10 feet of it. Each target must make a {13} Dexterity saving throw, taking 19 ( 3d10 + 3}) bludgeoning damage on a failed save, or half as much damage on a successful one.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Hold Breath",
        entries: ["The lizardfolk can hold its breath for 15 minutes."],
      },
    ],
    action: [
      {
    ...
    trait: [
      {
        name: "Blood Frenzy",
        entries: [
          "The render has advantage on melee attack rolls against any creature that doesn't have all its hit points.",
        ],
      },
      {
        name: "Hold Breath",
        entries: ["The render can hold its breath for 15 minutes."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: [
          "The render makes two attacks: one with its claws and one with its bite.",
        ],
      },
      {
        name: "Claws",
        entries: [
          "{5} to hit, reach 10 ft., one target. 12 ( 2d8 + 3}) slashing damage.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{5} to hit, reach 5 ft., one target. 8 ( 1d10 + 3}) piercing damage.",
        ],
      },
      {
        name: "Rend the Field {@recharge 5}",
        entries: [
          "The render makes a claw attack against each creature of its choice within 10 feet of it. A creature hit by this attack must succeed on a {13} Strength saving throw or be knocked {prone}.",
        ],
      },
    ],
    traitTags: ["Hold Breath"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Hold Breath",
        entries: ["The scaleshield can hold its breath for 15 minutes."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: [
          "The scaleshield makes two melee attacks, each one with a different weapon.",
        ],
      },
      {
        name: "Morningstar",
        entries: [
          "{4} to hit, reach 5 ft., one target. 6 ( 1d8 + 2}) piercing damage.",
        ],
      },
      {
        name: "Bite",
    ...
    reaction: [
      {
        name: "Shield Block",
        entries: [
          "If an ally within 5 feet of the scaleshield is hit by an attack, the scaleshield can reduce that attack's damage by half.",
        ],
      },
    ],
  ...
  },
  {
    ...
    spellcasting: [
      {
        name: "Spellcasting",
        headerEntries: [
          "The subchief is a 5th-level spellcaster. Its spellcasting ability is Wisdom (spell save {13}, {5} to hit with spell attacks). It has the following cleric spells prepared:",
        ],
        spells: {
          0: {
            spells: [
          ...
          1: {
            slots: 4,
            spells: ["{command}", "{Guiding Bolt}", "{purify food and drink}"],
          },
          2: {
            slots: 3,
            spells: ["{hold person}", "{lesser restoration}", "{silence}"],
          },
          3: {
            slots: 2,
            spells: ["{bestow curse}", "{dispel magic}"],
          },
        },
        ability: "wis",
      },
    ...
    trait: [
      {
        name: "Hold Breath",
        entries: ["The subchief can hold its breath for 15 minutes."],
      },
    ],
    action: [
      {
        name: "Tooth Dagger",
        entries: [
          "{4} to hit, reach 5 ft., one target. 4 ( 1d4 + 2}) piercing damage.",
        ],
      },
      {
        name: "Jaws of Semuanya {@recharge 5}",
        entries: [
          "The subchief invokes the primal magic of Semuanya, summoning a spectral maw around a target it can see within 60 feet of it. The target must make a {13} Dexterity saving throw, taking 22 ( 5d8}) piercing damage on a failed save, or half as much damage on a successful one. A creature that fails this saving throw is also {frightened} until the end of its next turn.",
        ],
      },
    ],
    traitTags: ["Hold Breath"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The locathah makes two melee attacks with its spear."],
      },
      {
        name: "Spear",
        entries: [
          "{3} to hit, reach 5 ft. or range 20/60 ft., one target. 4 ( 1d6 + 1}) piercing damage, or 5 ( 1d8 + 1}) piercing damage if used with two hands.",
        ],
      },
    ],
    attachedItems: ["spear|phb"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The hunter makes two attacks with its envenomed crossbow."],
      },
      {
        name: "Envenomed Crossbow",
        entries: [
          "{4} to hit, range 80/320 ft., one target. 11 ( 2d8 + 2}) piercing damage, and the target must succeed on a {12} Constitution saving throw or be {poisoned} until the end of its next turn.",
        ],
      },
      {
        name: "Club",
        entries: [
          "{3} to hit, reach 5 ft., one target. 4 ( 1d6 + 1}) bludgeoning damage.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Water Breathing",
        entries: ["The maw of Sekolah can breathe only underwater."],
      },
    ],
    action: [
      {
      ...
      },
      {
        name: "Bite",
        entries: [
          "{8} to hit, reach 10 ft., one target. 16 ( 2d10 + 5}) piercing damage.",
        ],
      },
      {
        name: "Tail Smash",
        entries: [
          "{8} to hit, reach 10 ft., one target. 9 ( 1d8 + 5}) bludgeoning damage.",
        ],
      },
    ],
    legendary: [
      {
        name: "Detect",
        entries: ["The maw of Sekolah makes a Wisdom (Perception) check."],
      },
      {
        name: "Speed of Sekolah",
        entries: ["The maw of Sekolah moves up to its speed."],
      },
      {
        name: "Feed (Costs 2 Actions)",
        entries: [
          "The ferocious spirit of Sekolah flashes through the water, tearing through the foes of the maw of Sekolah. Each creature of the maw's choosing within 60 feet of it must make a {16} Dexterity saving throw, taking 7 ( 2d6}) slashing damage on a failed save, or half as much damage on a successful one.",
        ],
      },
    ],
    traitTags: ["Legendary Resistances", "Water Breathing"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["OTH", "TP"],
    damageTags: ["B", "P", "S"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The salvager can breathe air and water."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The salvager makes two attacks with its coral rapier."],
      },
      {
        name: "Coral Rapier",
        entries: [
          "{@atk m} {4} to hit, reach 5 ft., one target. 6 ( 1d8 + 2}) piercing damage.",
        ],
      },
      {
        name: "Inject Toxin (2/Day)",
        entries: [
          "{@atk m} {4} to hit, reach 5 ft., one target. 6 ( 1d8 + 2}) piercing damage, and the creature must succeed on a {12} Constitution saving throw or be {paralyzed} until the end of its next turn.",
        ],
      },
    ],
    traitTags: ["Amphibious"],
  ...
  },
  {
    ...
    alignment: ["C", "E"],
    traitTags: ["Amphibious", "Keen Senses"],
    languageTags: ["AQ", "C", "X"],
    miscTags: ["MW"],
    hasToken: true,
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Greataxe",
        entries: [
          "{7} to hit, reach 5 ft., one target. 17 ( 2d12 + 4}) slashing damage.",
        ],
      },
      {
        name: "Gore",
        entries: [
          "{7} to hit, reach 5 ft., one target. 8 ( 1d8 + 4}) piercing damage.",
        ],
      },
    ],
    reaction: [
      {
        name: "Flying Shards",
        entries: [
          "In response to a creature hitting the statue with a melee weapon attack, the statue deals 11 ( 2d10}) piercing damage to the attacker.",
        ],
      },
    ],
  ...
  },
  {
    ...
    legendary: [
      {
        name: "Detect",
        entries: ["The peryton makes a Wisdom (Perception) check."],
      },
      {
        name: "Talons Attack",
        entries: ["The peryton makes one attack with its talons."],
      },
      {
  ...
  },
  {
    ...
    spellcasting: [
      {
        name: "Innate Spellcasting",
        headerEntries: [
          "Mr. Dory's innate spellcasting ability is Charisma (save {15}, {7} to hit with spell attacks). Mr. Dory can innately cast the following spells, requiring no material components:",
        ],
        will: [
          "{detect magic}",
          "{detect thoughts}",
        ...
        daily: {
          "2e": ["{fear}", "{fireball}", "{fly}"],
          "1e": ["{Cloudkill}", "{etherealness}"],
        },
        ability: "cha",
      },
    ],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Mr. Dory makes three attacks with his rapier."],
      },
      {
        name: "Rapier",
        entries: [
          "{9} to hit, reach 5 ft., one target. 9 ( 1d8 + 5}) piercing damage and 7 ( 2d6}) necrotic damage.",
        ],
      },
      {
        name: "Eye of Corruption {@recharge 5}",
        entries: [
          "Mr. Dory glares at a creature he can see within 30 feet of him. The target must make a {15} Constitution saving throw. On a failed save, it takes 27 ( 5d10}) necrotic damage and 27 ( 5d10}) poison damage and then gains vulnerability to both necrotic and poison damage for 1 minute. On a successful save, it takes half damage and does not gain the vulnerabilities.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["Oceanus can breathe air and water."],
      },
      {
        name: "Friend of the Sea",
        entries: [
          "Using gestures and sounds, Oceanus can communicate simple ideas with any beast that has an innate swimming speed.",
        ],
      },
    ],
    action: [
      ...
      },
      {
        name: "Light Crossbow",
        entries: [
          "{3} to hit, range 80/320 ft., one target. 5 ( 1d8 + 1}) piercing damage.",
        ],
      },
    ],
    attachedItems: ["light crossbow|phb", "trident|phb"],
    traitTags: ["Amphibious"],
    senseTags: ["D"],
    languageTags: ["AQ", "E"],
    damageTags: ["P"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Cargo Hauler",
        entries: ["The bosun has advantage on Strength checks."],
      },
      {
        name: "Sea Legs",
        entries: [
    ...
    action: [
      {
        name: "Light Hammer",
        entries: [
          "{5} to hit, reach 5 ft. or range 20/60 ft., one target. 5 ( 1d4 + 3}) bludgeoning damage.",
        ],
      },
      {
        name: "Hook",
        entries: [
          "{5} to hit, reach 5 ft., one target. 7 ( 1d8 + 3}) piercing damage, and the target is {grappled} (escape {13}).",
        ],
      },
    ],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Hand Crossbow",
        entries: [
          "{4} to hit, range 30/120 ft., one target. 5 ( 1d6 + 2}) piercing damage.",
        ],
      },
      {
        name: "Longsword",
        entries: [
          "{5} to hit, reach 5 ft., one target. 9 ( 1d8 + 5}) slashing damage, or 10 ( 1d10 + 5}) slashing damage if used with two hands.",
        ],
      },
    ],
    reaction: [
    ...
    attachedItems: ["hand crossbow|phb", "longsword|phb"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "X"],
    damageTags: ["P", "S"],
    miscTags: ["MW", "RNG", "RW"],
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 3,
            spells: ["{Gust of Wind}", "{Melf's acid arrow}", "{misty step}"],
          },
        },
        ability: "int",
      },
    ...
    action: [
      {
        name: "Quarterstaff",
        entries: [
          "{2} to hit, reach 5 ft., one target. 3 ( 1d6}) bludgeoning damage.",
        ],
      },
    ],
    attachedItems: ["quarterstaff|phb"],
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          1: {
            slots: 4,
            spells: ["{expeditious retreat}", "{Magic Missile}", "{shield}"],
          },
          2: {
            slots: 3,
            spells: ["{blur}", "{hold person}"],
          },
          3: {
            slots: 2,
            spells: ["{sleet storm}"],
    ...
    action: [
      {
        name: "Quarterstaff",
        entries: [
          "{4} to hit, reach 5 ft., one target. 6 ( 1d8 + 2}) bludgeoning damage.",
        ],
      },
    ],
    attachedItems: ["quarterstaff|phb"],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        ...
        entries: [
          "{6} to hit, reach 5 ft., one target. 12 ( 2d8 + 3}) slashing damage.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{6} to hit, reach 5 ft., one target. 8 ( 1d10 + 3}) piercing damage.",
        ],
      },
      {
        name: "Claws",
        entries: [
          "{6} to hit, reach 5 ft., one target. 7 ( 1d8 + 3}) slashing damage.",
        ],
      },
    ],
    senseTags: ["SD"],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Spear",
        entries: [
          "{5} to hit, reach 5 ft. or range 20/60 ft., one target. 6 ( 1d6 + 3}) piercing damage, or 7 ( 1d8 + 3}) piercing damage if used with two hands to make a melee attack.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{5} to hit, reach 5 ft., one target. 5 ( 1d4 + 3}) piercing damage.",
        ],
      },
      {
        name: "Claws",
        entries: [
          "{5} to hit, reach 5 ft., one target. 6 ( 1d6 + 3}) slashing damage.",
        ],
      },
    ],
    attachedItems: ["spear|phb"],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Warhammer",
        entries: [
          "{5} to hit, reach 5 ft., one target. 7 ( 1d8 + 3}) bludgeoning damage.",
        ],
      },
      {
        name: "Bite",
      ...
      },
      {
        name: "Claws",
        entries: [
          "{5} to hit, reach 5 ft., one target. 5 ( 1d4 + 3}) slashing damage.",
        ],
      },
    ],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Glaive",
        entries: [
          "{4} to hit, reach 10 ft., one target. 13 ( 2d10 + 2}) slashing damage.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{4} to hit, reach 5 ft., one target. 7 ( 1d10 + 2}) piercing damage.",
        ],
      },
      {
        name: "Claws",
        entries: [
          "{4} to hit, reach 5 ft., one target. 6 ( 1d8 + 2}) slashing damage.",
        ],
      },
      {
    ...
    action: [
      {
        name: "Bites",
        entries: [
          "{6} to hit, reach 0 ft., one creature in the swarm's space. 14 ( 4d6}) piercing damage, or 7 ( 2d6}) piercing damage if the swarm has half of its hit points or fewer.",
        ],
      },
    ],
    traitTags: ["Water Breathing"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        spells: {
          ...
          2: {
            slots: 3,
            spells: ["{hold person}", "{spiritual weapon} (trident)"],
          },
          3: {
            slots: 3,
            spells: [
    ...
    action: [
      ...
      },
      {
        ...
        entries: [
          "{5} to hit, reach 5 ft., one target. 11 ( 2d8 + 2}) piercing damage.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{5} to hit, reach 5 ft., one target. 4 ( 1d4 + 2}) piercing damage.",
        ],
      },
      {
        name: "Claws",
        entries: [
          "{5} to hit, reach 5 ft., one target. 4 ( 1d4 + 2}) slashing damage.",
        ],
      },
    ],
    senseTags: ["SD"],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Bite",
        entries: [
          "{4} to hit, reach 5 ft., one target. 10 ( 2d8 + 1}) piercing damage plus 13 ( 3d8}) cold damage.",
        ],
      },
      {
        name: "Claws",
        entries: [
          "{4} to hit, reach 5 ft., one target. 10 ( 2d8 + 1}) slashing damage plus 13 ( 3d8}) cold damage.",
        ],
      },
      {
    ...
    spellcasting: [
      {
        name: "Spellcasting",
        headerEntries: [
          "Sanbalet is a 3rd-level spellcaster. His spellcasting ability is Intelligence (spell save {13}, {5} to hit with spell attacks). He has the following wizard spells prepared:",
        ],
        spells: {
          0: {
            spells: ["{dancing lights}", "{minor illusion}", "{Ray of Frost}"],
          },
          1: {
            slots: 4,
            spells: [
          ...
          2: {
            slots: 2,
            spells: ["{magic mouth}", "{scorching ray}"],
          },
        },
        ability: "int",
      },
    ...
    action: [
      {
        name: "Dagger",
        entries: [
          "{3} to hit, reach 5 ft. or range 20/60 ft., one target. 3 ( 1d4 + 1}) piercing damage.",
        ],
      },
    ],
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        name: "Magic Resistance",
        entries: [
          "The shark has advantage on saving throws against spells and other magical effects.",
        ],
      },
      {
        name: "Water Breathing",
    ...
    traitTags: ["Magic Resistance", "Water Breathing"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    damageTags: ["P"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The skeletal alchemist makes two Lob Acid attacks."],
      },
      {
        name: "Claws",
        entries: [
          "{3} to hit, reach 5 ft. one target. 4 ( 1d6 + 1}) slashing damage.",
        ],
      },
      {
        name: "Lob Acid",
        entries: [
          "{3} to hit, range 30/120 ft., one target. 5 ( 1d8 + 1}) acid damage.",
        ],
      },
    ],
    traitTags: ["Magic Resistance"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Disassemble",
        entries: [
          "If the juggernaut is reduced to 0 hit points, twelve skeletons rise from its remains.",
        ],
      },
      {
        name: "Falling Apart",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The juggernaut makes two claws attacks."],
      },
      {
        name: "Claws",
        entries: [
          "{6} to hit, reach 10 ft., one target. 12 ( 2d8 + 3}) slashing damage.",
        ],
      },
      {
        name: "Avalanche of Bones {@recharge 5}",
        entries: [
          "The juggernaut collapses into a large heap before quickly reforming. Each creature within 10 feet of the juggernaut must make a {14} Dexterity saving throw, taking 18 ( 4d8}) bludgeoning damage on a failed save, or half as much damage on a successful one. A creature that fails this saving throw is also knocked {prone}.",
        ],
      },
    ],
    senseTags: ["D"],
    ...
    trait: [
      {
        ...
        entries: ["Creatures are {deafened} while in the swarm's space."],
      },
      {
        name: "Swarm",
        entries: [
    ...
    action: [
      {
        name: "Slash",
        entries: [
          "{4} to hit, reach 0 ft., one target in the swarm's space. 11 ( 2d8 + 2}) slashing damage, or 6 ( 1d8 + 2}) slashing damage if the swarm has half of its hit points or fewer.",
        ],
      },
    ],
    senseTags: ["D"],
  ...
  },
  {
    ...
    trait: [
      {
        ...
        entries: ["The skum is permanently {charmed} by its aboleth master."],
      },
      {
        name: "Amphibious",
        entries: ["The skum can breathe air and water."],
      },
      {
        name: "Psychic Conditioning",
        entries: [
          "The skum is immune to the {frightened} and {charmed} conditions unless they are from effects created by an aboleth.",
        ],
      },
      {
        name: "Water Dependency",
    ...
    action: [
      ...
      },
      {
        name: "Trident",
        entries: [
          "{7} to hit, reach 5 ft., one target. 7 ( 1d6 + 4}) piercing damage.",
        ],
      },
      {
        name: "Mind-Breaking Touch",
        entries: [
          "{7} to hit, reach 5 ft., one target. 18 ( 4d8}) psychic damage, and the target has disadvantage on Wisdom saving throws until the end of the skum's next turn.",
        ],
      },
    ],
    attachedItems: ["trident|phb"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Hold Breath",
        entries: ["Thousand Teeth can hold its breath for 30 minutes."],
      },
      {
        name: "Legendary Resistance (2/Day)",
        entries: [
          "If Thousand Teeth fails a saving throw, it can choose to succeed instead.",
        ],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: [
          "Thousand Teeth makes two attacks: one with its bite and one with its tail.",
        ],
      },
      {
        name: "Bite",
        entries: [
          "{7} to hit, reach 5 ft., one target. 15 ( 2d10 + 4}) piercing damage.",
        ],
      },
      {
        name: "Tail",
        entries: [
          "{7} to hit, reach 10 ft., one target. 8 ( 1d8 + 4}) bludgeoning damage. If the target is a creature, it must succeed on a {15} Strength saving throw or be knocked {prone}.",
        ],
      },
    ],
    legendary: [
      {
        name: "Detect",
        entries: ["Thousand Teeth makes a Wisdom (Perception) check."],
      },
      {
        name: "Lunge",
        entries: ["Thousand Teeth moves up to half its speed."],
      },
      {
        name: "Bite (Costs 2 Actions)",
        entries: ["Thousand Teeth makes a bite attack."],
      },
    ],
    traitTags: ["Hold Breath", "Legendary Resistances"],
    actionTags: ["Multiattack"],
    damageTags: ["B", "P"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["prone"],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        name: "Bite",
        entries: [
          "{6} to hit, reach 5 ft., one target. 10 ( 2d6 + 3}) piercing damage. If the target is a creature, that creature becomes cursed by the statue. The curse lasts for 10 minutes. While the creature is cursed, the statue has advantage on all attacks against it.",
        ],
      },
      {
        name: "Claws",
    ...
    legendary: [
      {
        name: "Bite",
        entries: ["The statue makes one bite attack."],
      },
      {
        name: "Blood Reaper",
        entries: [
    ...
    traitTags: ["Immutable Form", "Legendary Resistances"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["CS"],
    damageTags: ["N", "P", "S"],

export const mpmmMonsters = [
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The abjurer makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
    ...
    spellcastingTags: ["O"],
    miscTags: ["AOE"],
    conditionInflictSpell: ["incapacitated", "invisible"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The kruthik makes two Stab or Spike attacks."],
      },
      {
        name: "Stab",
        entries: [
    ...
    traitTags: ["Pack Tactics", "Tunneler"],
    senseTags: ["D", "T"],
    actionTags: ["Multiattack"],
    languageTags: ["OTH"],
    damageTags: ["P"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The oblex doesn't require sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Amorphous", "Unusual Nature"],
    senseTags: ["B"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "X"],
    damageTags: ["B", "Y"],
    ...
    conditionInflictSpell: ["blinded", "charmed", "incapacitated", "paralyzed"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The myrmidon makes three Flail attacks."],
      },
      {
        name: "Flail",
        entries: [
  ...
  },
  {
    ...
    traitTags: ["Magic Resistance", "Turn Resistance"],
    senseTags: ["U"],
    actionTags: ["Multiattack"],
    ...
    trait: [
      ...
      },
      {
        ...
        entries: [
          ...
          "If the saving throw against Foment Confusion fails by 5 or more, the creature is instead subjected to the {@spell confusion} spell for 1 minute (no {@status concentration} required by the alkilith). While under the effect of that confusion, the creature is immune to Foment Confusion.",
        ],
      },
      {
        name: "Magic Resistance",
      ...
      {
        name: "Unusual Nature",
        entries: ["The alkilith doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The alkilith makes three Tentacle attacks."],
      },
      {
        name: "Tentacle",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The allip doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Incorporeal Movement", "Unusual Nature"],
    senseTags: ["D"],
    languageTags: ["LF"],
    damageTags: ["O", "Y"],
    miscTags: ["AOE"],
  ...
  },
  {
    ...
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["blinded", "stunned"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The sorrowsworn makes two Hook attacks."],
      },
      {
        name: "Hook",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The annis makes one Bite attack and two Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The archer makes two Shortsword or Longbow attacks."],
      },
      {
        name: "Shortsword",
        entries: [
  ...
  },
  {
    ...
    legendary: [
      {
        name: "Claw",
        entries: ["The dreadnought makes one Claw attack."],
      },
      {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell hold person}"],
        daily: {
          "2e": [
            "{@spell cure wounds} (as a 5th-level spell)",
            "{@spell lesser restoration}",
          ],
          "1e": ["{@spell greater restoration}", "{@spell revivify}"],
        },
        ability: "cha",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Bael makes two Hellish Morningstar attacks."],
      },
      {
    ...
    legendary: [
      {
        name: "Fiendish Magic",
        entries: ["Bael uses Spellcasting or Teleport."],
      },
      {
        name: "Infernal Command",
        entries: ["Bael uses Infernal Command."],
      },
      {
        name: "Attack (Costs 2 Actions)",
        entries: ["Bael makes one Hellish Morningstar attack."],
      },
    ],
    soundClip: {
      type: "internal",
  ...
  },
  {
    ...
    conditionInflictLegendary: ["invisible"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
    ...
    legendary: [
      {
        ...
        entries: ["Baphomet makes one Heartcleaver attack."],
      },
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The barghest makes one Bite attack and one Claw attack."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The hag makes two Slam or Frost Shard attacks."],
      },
      {
        name: "Slam",
        entries: [
    ...
    spellcasting: [
      {
        ...
        headerEntries: [
          "The abishai casts {@spell darkness} at a point within 120 feet of it, requiring no spell components or {@status concentration}. Wisdom is its spellcasting ability for this spell. While the spell persists, the abishai can move the area of darkness up to 60 feet as a bonus action.",
        ],
        recharge: {
          6: ["{@spell darkness}"],
        },
  ...
  },
  {
    ...
    attachedItems: ["glaive|phb", "shortbow|phb"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "X"],
    damageTags: ["N", "P", "S"],
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH", "RNG", "RW"],
    conditionInflict: ["blinded", "frightened", "prone"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The abishai makes three Bite or Lightning Strike attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The bodak doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Sunlight Sensitivity", "Unusual Nature"],
    senseTags: ["SD"],
    languageTags: ["AB", "LF"],
    damageTags: ["B", "N", "R", "Y"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The boneclaw doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The boneclaw makes two Piercing Claw attacks."],
      },
      {
        name: "Piercing Claw",
        entries: [
    ...
    traitTags: ["Rejuvenation", "Unusual Nature"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["C"],
    damageTags: ["N", "P"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The collector doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The collector makes two Slam attacks."],
      },
      {
        name: "Slam",
        entries: [
    ...
    trait: [
      {
        ...
        entries: ["The champion rerolls a failed saving throw."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The champion makes three Greatsword or Shortbow attacks."],
      },
      {
        name: "Greatsword",
        entries: [
    ...
    bonus: [
      {
        ...
        entries: ["The champion regains 20 hit points."],
      },
    ],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The chitine makes three Dagger attacks."],
      },
      {
        name: "Dagger",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        ...
        entries: ["The choker can take an extra action on its turn."],
      },
      {
        name: "Boneless",
        entries: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The choker makes two Tentacle attacks."],
      },
      {
        name: "Tentacle",
        entries: [
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell guidance}", "{@spell thaumaturgy}"],
        daily: {
          "1e": ["{@spell bane}", "{@spell hold person}"],
        },
        ability: "wis",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The clockwork doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
          ...
          "{@atk mw} {@hit 5} to hit, reach 5 ft., one target. {@h}6 ({@damage 1d6 + 3}) piercing damage. If the target is a creature, it must succeed on a {@dc 13} Constitution saving throw or suffer one random effect (roll a {@dice d6}):",
          {
            ...
            items: [
              ...
              },
              {
                name: "5\u20136: Poison",
                type: "item",
                entries: ["The target takes 13 ({@damage 3d8}) poison damage."],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          ...
          "1e": ["{@spell fly}", "{@spell stinking cloud}", "{@spell web}"],
        },
        ability: "int",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The conjurer makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
  ...
  },
  {
    ...
    passive: 12,
    conditionImmune: ["blinded", "deafened", "poisoned"],
    cr: "8",
    trait: [
      {
        name: "Corpses",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The corpse flower makes three Tentacle attacks."],
      },
      {
        name: "Tentacle",
        entries: [
  ...
  },
  {
    ...
    ac: [
      {
        ac: 15,
        from: ["{@item studded leather armor|PHB}"],
      },
    ],
    hp: {
      average: 27,
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The darkling elder makes two Scimitar attacks."],
      },
      {
        name: "Scimitar",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The deathlock doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Turn Resistance", "Unusual Nature"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["LF"],
    damageTags: ["N"],
    ...
    spellcastingTags: ["O"],
    miscTags: ["MW"],
    conditionInflictSpell: ["blinded", "invisible"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    traitTags: ["Devil's Sight", "Turn Resistance", "Unusual Nature"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["LF"],
    damageTags: ["N"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell fear}", "{@spell hold person}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The deathlock makes two Life Drain or Grave Bolt attacks."],
      },
      {
        name: "Life Drain",
        entries: [
    ...
    spellcastingTags: ["O"],
    miscTags: ["HPR", "MW"],
    conditionInflictSpell: ["frightened", "paralyzed"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell detect magic}", "{@spell major image}"],
        daily: {
          "3e": [
            "{@spell dispel magic}",
            "{@spell fear}",
          ...
          "1e": ["{@spell feeblemind}", "{@spell project image}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["Demogorgon uses Spellcasting."],
      },
    ],
    legendaryGroup: {
      name: "Demogorgon",
    ...
    conditionInflictSpell: ["blinded", "deafened", "frightened", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    attachedItems: ["light crossbow|phb"],
    traitTags: ["Magic Resistance", "Sunlight Sensitivity"],
    senseTags: ["SD"],
    languageTags: ["D", "U"],
    damageTags: ["P"],
    miscTags: ["MW", "RNG", "RW"],
  ...
  },
  {
    ...
    spellcastingTags: ["O"],
    miscTags: ["MW"],
    conditionInflictSpell: ["invisible", "unconscious"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    trait: [
      {
        name: "Unusual Nature",
        entries: ["A devourer doesn't require air, drink, or sleep."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell darkness}", "{@spell fear}"],
        ability: "cha",
        displayAs: "action",
      },
    ],
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The dhergoloth makes two Claw attacks."],
      },
      {
        name: "Claw",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: [" The troll makes one Bite attack and four Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The diviner makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Hold Breath",
        entries: ["The dolphin can hold its breath for 20 minutes."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The dolphin makes two Dazzling Slam attacks."],
      },
      {
        name: "Dazzling Slam",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell dancing lights}", "{@spell darkness}"],
        daily: {
          "1e": ["{@spell confusion}", "{@spell faerie fire}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The draegloth makes one Bite attack and two Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Web Walker",
        entries: ["The drow ignores movement restrictions caused by webbing."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    attachedItems: ["hand crossbow|phb", "scimitar|phb", "whip|phb"],
    traitTags: ["Fey Ancestry", "Sunlight Sensitivity"],
    senseTags: ["SD"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The drow makes three Death Lance attacks."],
      },
      {
        name: "Death Lance",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      },
      {
        ...
        entries: ["The drow wields a {@item tentacle rod}."],
      },
      {
        name: "Sunlight Sensitivity",
        entries: [
    ...
    legendary: [
      ...
      {
        name: "Demon Staff",
        entries: ["The drow makes one Demon Staff attack."],
      },
      {
        name: "Cast a Spell (Costs 2 Actions)",
        entries: ["The drow uses Spellcasting."],
      },
    ],
    legendaryGroup: {
      name: "Drow Matron Mother",
    ...
    conditionInflictSpell: ["deafened", "incapacitated", "paralyzed", "prone"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell dancing lights}", "{@spell darkness}"],
        daily: {
          "1e": ["{@spell faerie fire}", "{@spell levitate} (self only)"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    attachedItems: ["hand crossbow|phb"],
    traitTags: ["Devil's Sight", "Fey Ancestry", "Sunlight Sensitivity"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["E", "U"],
    damageTags: ["N", "P", "Y"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The hammerer makes one Claw attack and one Hammer attack."],
      },
      {
        name: "Claw",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The duergar makes two War Pick attacks."],
      },
      {
        name: "War Pick",
        entries: [
    ...
    attachedItems: ["heavy crossbow|phb", "war pick|phb"],
  ...
  },
  {
    ...
    action: [
      ...
      },
      {
        ...
        entries: [
          "The duergar magically turns {@condition invisible} for up to 1 hour or until it attacks, it forces a creature to make a saving throw, or its {@status concentration} is broken (as if {@status concentration||concentrating} on a spell). Any equipment the duergar wears or carries is {@condition invisible} with it.",
        ],
      },
      {
        name: "Mind Mastery",
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The duergar makes two Shortsword or Javelin attacks."],
      },
      {
        name: "Shortsword",
        entries: [
    ...
    attachedItems: ["javelin|phb", "shortsword|phb"],
    traitTags: ["Sunlight Sensitivity"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["D", "U"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The myrmidon makes two Maul attacks."],
      },
      {
        name: "Maul",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The eidolon doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Incorporeal Movement", "Turn Resistance", "Unusual Nature"],
    senseTags: ["D"],
    languageTags: ["LF"],
    damageTags: ["O"],
    miscTags: ["AOE"],
    conditionInflict: ["frightened", "stunned"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
    ...
    legendary: [
      {
        ...
        entries: [
          "The elder brain targets one creature within 120 feet of it with which it has a psychic link. The elder brain breaks the creature's {@status concentration} on a spell it has cast. The creature also takes 2 ({@damage 1d4}) psychic damage per level of the spell.",
        ],
      },
      {
        name: "Psychic Pulse",
      ...
      },
      {
        ...
        entries: ["The elder brain makes one Tentacle attack."],
      },
    ],
    legendaryGroup: {
      name: "Elder Brain",
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Siege Monster",
        entries: ["The tempest deals double damage to objects and structures."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The tempest makes two Thunderous Slam attacks."],
      },
      {
    ...
    legendary: [
      {
        name: "Move",
        entries: ["The tempest moves up to its speed."],
      },
      {
    ...
    traitTags: ["Flyby", "Legendary Resistances", "Siege Monster"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    damageTags: ["B", "L", "T"],
    miscTags: ["AOE", "MW", "RCH"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell friends}", "{@spell mage hand}", "{@spell message}"],
        daily: {
          "2e": [
            "{@spell charm person}",
            "{@spell mage armor}",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The enchanter makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
    ...
    damageTags: ["Y"],
    spellcastingTags: ["O"],
    conditionInflictSpell: ["charmed", "invisible", "paralyzed"],
    hasToken: true,
    hasFluff: true,
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The evoker makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The myrmidon makes three Scimitar attacks."],
      },
      {
        name: "Scimitar",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The giant makes two Fireshield or Rock attacks."],
      },
      {
        name: "Fireshield",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The firenewt can breathe air and water."],
      },
      {
        name: "Devil's Sight",
        entries: [
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The firenewt makes three Morningstar or Fire Ray attacks."],
      },
      {
        name: "Morningstar",
        entries: [
    ...
    traitTags: ["Amphibious", "Devil's Sight"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["DR", "IG"],
    damageTags: ["F", "P"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The firenewt makes two Scimitar attacks."],
      },
      {
        name: "Scimitar",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The snail makes five Flail Tentacle attacks."],
      },
      {
        name: "Flail Tentacle",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          ...
          "1e": ["{@spell modify memory}", "{@spell project image}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["Fraz-Urb'luu uses Phantasmal Terror."],
      },
    ],
    legendaryGroup: {
      name: "Fraz-Urb'luu",
    ...
    damageTagsSpell: ["B", "P", "S", "Y"],
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["frightened", "grappled"],
    conditionInflictSpell: [
      "blinded",
      "charmed",
      "deafened",
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The froghemoth can breathe air and water."],
      },
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The giant makes two Greataxe or Rock attacks."],
      },
      {
        name: "Greataxe",
        entries: [
  ...
  },
  {
    ...
    damageTags: ["F", "N", "O", "P"],
    miscTags: ["AOE", "MW"],
    conditionInflict: ["paralyzed", "stunned", "unconscious"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Geryon makes one Claw attack and one Stinger attack."],
      },
      {
        name: "Claw",
        entries: [
    ...
    legendary: [
      ...
      {
        name: "Teleport",
        entries: ["Geryon uses Teleport."],
      },
      {
        name: "Swift Sting (Costs 2 Actions)",
        entries: ["Geryon makes one Stinger attack."],
      },
    ],
    legendaryGroup: {
      name: "Geryon",
    ...
    damageTagsSpell: ["B", "C", "P", "S"],
    spellcastingTags: ["O"],
    miscTags: ["HPR", "MW", "RCH"],
    conditionInflict: ["frightened", "grappled", "poisoned"],
    conditionInflictLegendary: ["restrained"],
    conditionInflictSpell: ["incapacitated", "invisible"],
    hasToken: true,
    hasFluff: true,
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The giff makes two Longsword, Musket, or Pistol attacks."],
      },
      {
        name: "Longsword",
        entries: [
    ...
    attachedItems: ["longsword|phb", "musket|dmg", "pistol|dmg"],
    actionTags: ["Multiattack"],
    languageTags: ["C"],
    damageTags: ["B", "P", "S"],
    miscTags: ["AOE", "MW", "RW"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The girallon makes one Bite attack and four Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell mage hand} (the hand is invisible)"],
        daily: {
          "3e": ["{@spell blur}", "{@spell nondetection} (self only)"],
          "1e": ["{@spell plane shift}", "{@spell telekinesis}"],
        },
        ability: "int",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The githyanki makes three Greatsword attacks."],
      },
      {
        name: "Greatsword",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The githyanki makes two Silver Greatsword attacks."],
      },
      {
    ...
    legendary: [
      ...
      },
      {
        ...
        entries: ["The githyanki makes one Silver Greatsword attack."],
      },
    ],
    environment: ["desert", "mountain", "urban"],
    soundClip: {
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell mage hand} (the hand is invisible)"],
        daily: {
          "3e": ["{@spell see invisibility}", "{@spell telekinesis}"],
          "1e": [
            "{@spell globe of invulnerability}",
            "{@spell plane shift}",
            "{@spell wall of force}",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The githzerai makes three Unarmed Strike attacks."],
      },
      {
        name: "Unarmed Strike",
        entries: [
    ...
    legendary: [
      {
        name: "Strike",
        entries: ["The githzerai makes one Unarmed Strike attack."],
      },
      {
        name: "Teleport",
        entries: [
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell mage hand} (the hand is invisible)"],
        daily: {
          3: ["{@spell see invisibility}"],
          "1e": ["{@spell plane shift}", "{@spell teleport}"],
        },
        ability: "wis",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The gnoll makes two Bite, Spear, or Longbow attacks."],
      },
      {
        name: "Bite",
        entries: [
    ...
    attachedItems: ["longbow|phb", "spear|phb"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["OTH"],
    damageTags: ["P"],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Unusual Nature",
        entries: ["The witherling doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The witherling makes two Bite or Spiked Club attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          ...
          "1e": ["{@spell dominate monster}", "{@spell greater invisibility}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    legendary: [
      {
        name: "Abyssal Magic",
        entries: ["Graz'zt uses Spellcasting or Teleport."],
      },
      {
        name: "Attack",
        entries: ["Graz'zt makes one Wave of Sorrow attack."],
      },
      {
    ...
    traitTags: ["Legendary Resistances", "Magic Resistance"],
    senseTags: ["U"],
    actionTags: ["Multiattack", "Shapechanger", "Teleport"],
    languageTags: ["TP", "XX"],
    damageTags: ["A", "O"],
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell alter self}", "{@spell major image}"],
        daily: {
          "3e": [
            "{@spell charm person}",
            "{@spell detect thoughts}",
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The grung can breathe air and water."],
      },
      {
        name: "Poisonous Skin",
        entries: [
    ...
    damageTags: ["I", "P"],
    miscTags: ["MW", "RW", "THW"],
    conditionInflict: ["charmed", "frightened", "poisoned"],
    hasToken: true,
    hasFluff: true,
    _versions: [
      {
  ...
  },
  {
    ...
    attachedItems: ["dagger|phb", "shortbow|phb"],
    traitTags: ["Amphibious"],
    languageTags: ["OTH"],
    damageTags: ["I", "P"],
    miscTags: ["MW", "RNG", "RW", "THW"],
    conditionInflict: ["charmed", "frightened", "poisoned", "stunned"],
    hasToken: true,
    hasFluff: true,
    _versions: [
      {
    ...
    spellcasting: [
      {
        ...
        daily: {
          2: ["{@spell plant growth}"],
          "3e": ["{@spell cure wounds}", "{@spell spike growth}"],
        },
        ability: "wis",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The guard drake makes one Bite attack and one Tail attack."],
      },
      {
        name: "Bite",
        entries: [
    ...
    _versions: [
      {
        ...
        _mod: {
          trait: {
            ...
            items: {
              name: "Amphibious",
              entries: ["The drake can breathe air and water."],
            },
          },
        },
        speed: {
  ...
  },
  {
    ...
    traitTags: ["Immutable Form", "Magic Resistance", "Unusual Nature"],
    senseTags: ["SD"],
    languageTags: ["CS", "I"],
    damageTags: ["A", "B", "F", "L", "T"],
    miscTags: ["AOE", "RCH"],
    conditionInflict: ["prone", "restrained"],
    hasToken: true,
    hasFluff: true,
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell minor illusion}", "{@spell prestidigitation}"],
        daily: {
          "1e": [
            "{@spell charm person}",
            "{@spell disguise self}",
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The howler makes two Rending Bite attacks."],
      },
      {
        name: "Rending Bite",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The sorrowsworn makes one Bite attack and one Claw attack."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Hutijin makes one Claw, Mace, or Tail attack."],
      },
      {
        name: "Teleport",
        entries: ["Hutijin uses Teleport."],
      },
      {
    ...
    actionTags: ["Multiattack", "Teleport"],
    languageTags: ["TP", "XX"],
    damageTags: ["C", "F", "I", "L", "O", "T"],
    damageTagsSpell: ["B", "F", "L", "P", "S"],
    spellcastingTags: ["O"],
    miscTags: ["AOE", "MW", "RCH"],
    conditionInflict: ["frightened", "poisoned"],
    conditionInflictSpell: ["invisible", "paralyzed"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The hydroloth can breathe air and water."],
      },
      {
        name: "Magic Resistance",
        entries: [
    ...
    spellcastingTags: ["O"],
    miscTags: ["MW"],
    conditionInflictSpell: ["charmed", "frightened", "invisible"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The illusionist makes two Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          "3e": ["{@spell contagion}", "{@spell gaseous form}"],
        },
        ability: "wis",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Juiblex makes three Acid Lash attacks."],
      },
      {
        name: "Acid Lash",
        entries: [
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Juiblex makes one Acid Lash attack."],
      },
      {
    ...
    miscTags: ["MW", "RCH", "RW"],
    conditionInflict: ["poisoned"],
    conditionInflictLegendary: ["prone", "restrained"],
    conditionInflictSpell: ["blinded", "poisoned", "stunned"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    legendary: [
      ...
      {
        name: "Smite",
        entries: ["The ki-rin makes one Hoof, Horn, or Sacred Fire attack."],
      },
    ],
    legendaryGroup: {
      name: "Ki-rin",
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The kobold makes two Spear attacks."],
      },
      {
        name: "Spear",
        entries: [
  ...
  },
  {
    ...
    attachedItems: ["dagger|phb", "sling|phb"],
    traitTags: ["Pack Tactics", "Sunlight Sensitivity"],
    senseTags: ["D"],
    languageTags: ["C", "DR"],
    damageTags: ["A", "B", "F", "I", "P"],
    miscTags: ["MW", "RNG", "RW", "THW"],
    conditionInflict: ["incapacitated"],
    hasToken: true,
    hasFluff: true,
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          1: ["{@spell Otto's irresistible dance}"],
        },
        ability: "wis",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The korred makes two Greatclub or Rock attacks."],
      },
      {
        name: "Greatclub",
        entries: [
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          1: ["{@spell Evard's black tentacles}"],
          "3e": [
            "{@spell control water}",
            "{@spell darkness}",
    ...
    spellcastingTags: ["O"],
    conditionInflict: ["frightened", "prone"],
    conditionInflictSpell: ["prone", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The leucrotta makes one Bite attack and one Hooves attack."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The leviathan makes one Slam attack and one Tail attack."],
      },
      {
        name: "Slam",
        entries: [
    ...
    legendary: [
      {
        name: "Move",
        entries: ["The leviathan moves up to its speed."],
      },
      {
        name: "Slam (Costs 2 Actions)",
        entries: ["The leviathan makes one Slam attack."],
      },
    ],
    environment: ["coastal", "underwater"],
    soundClip: {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The sorrowsworn makes two Arm Spike attacks."],
      },
      {
        name: "Arm Spike",
        entries: [
          ...
          "{@atk mw} {@hit 5} to hit, reach 5 ft., one target. {@h}7 ({@damage 1d8 + 3}) bludgeoning damage. Once per turn, the adept can cause one of the following additional effects (choose one or roll a {@dice d4}):",
          {
            ...
            items: [
              ...
              },
              {
                ...
                name: "3\u20134: Push.",
                entry:
                  "The target must succeed on a {@dc 13} Strength saving throw or be pushed up to 10 feet directly away from the adept.",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The marut doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The marut makes two Unerring Slam attacks."],
      },
      {
        name: "Unerring Slam",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The thief makes three Shortsword or Shortbow attacks."],
      },
      {
        name: "Shortsword",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The maurezhi makes one Bite attack and one Claw attack."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The merregon makes three Halberd attacks."],
      },
      {
        name: "Halberd",
        entries: [
    ...
    attachedItems: ["halberd|phb", "heavy crossbow|phb"],
    traitTags: ["Devil's Sight", "Magic Resistance"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["CS", "I", "TP"],
    damageTags: ["P", "S"],
    miscTags: ["MW", "RCH", "RNG", "RW"],
    hasToken: true,
    hasFluff: true,
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The merrenoloth makes one Oar attack and uses Fear Gaze."],
      },
      {
        name: "Oar",
        entries: [
  ...
  },
  {
    ...
    damageTags: ["P", "Y"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["frightened", "grappled", "restrained", "stunned"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Moloch makes one Bite, Claw, or Many-Tailed Whip attack."],
      },
      {
        name: "Teleport",
        entries: ["Moloch uses Teleport."],
      },
      {
        name: "Cast a Spell (Costs 2 Actions)",
        entries: ["Moloch uses Spellcasting."],
      },
    ],
    soundClip: {
      type: "internal",
  ...
  },
  {
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["The molydeus makes one Demonic Weapon or Snakebite attack."],
      },
      {
        name: "Move",
        entries: [
      ...
      {
        name: "Cast a Spell (Costs 2 Actions)",
        entries: ["The molydeus uses Spellcasting."],
      },
    ],
    variant: [
      {
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The morkoth can breathe air and water."],
      },
    ],
    action: [
      {
    ...
    spellcastingTags: ["O"],
    miscTags: ["AOE", "MW", "RCH"],
    conditionInflict: ["charmed", "grappled", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
            ...
            items: [
              {
                ...
                name: "1\u20133:",
                entry:
                  "The giant makes three Fist attacks against one random creature within reach. If no creatures are within reach, the giant flies into a rage and gains advantage on all attack rolls until the end of its next turn.",
              },
              {
                type: "item",
                name: "4\u20135:",
              ...
              },
              {
                ...
                name: "6\u20137:",
                entry:
                  "The giant makes one Bite attack against one random creature within reach. If no other creatures are within reach, its eyes glaze over and it is {@condition stunned} until the start of its next turn.",
              },
              {
                type: "item",
                name: "8\u201310:",
                entry:
                  "The giant makes one Bite attack and two Fist attacks against one random creature within reach. If no creatures are within reach, the giant flies into a rage and gains advantage on all attack rolls until the end of its next turn.",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    languageTags: ["C", "X"],
    damageTags: ["B", "N"],
    damageTagsSpell: ["F", "O", "Y"],
    spellcastingTags: ["O"],
    miscTags: ["AOE", "MW"],
    conditionInflict: ["charmed", "paralyzed"],
    conditionInflictSpell: ["charmed", "paralyzed"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    attachedItems: ["hellfire lance|bgdia"],
    traitTags: ["Magic Resistance"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "I", "TP"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The necromancer makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The neogi makes one Bite attack and two Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    traitTags: ["Devil's Sight", "Spider Climb"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "DS", "TP", "U"],
    damageTags: ["I", "N", "P"],
    damageTagsSpell: ["A", "C", "O"],
    spellcastingTags: ["O"],
    miscTags: ["MW"],
    conditionInflict: ["charmed", "poisoned"],
    conditionInflictSpell: ["blinded", "paralyzed"],
    hasToken: true,
    hasFluff: true,
  },
  {
    ...
    traitTags: ["Magic Resistance"],
    senseTags: ["B"],
    actionTags: ["Breath Weapon", "Swallow", "Tentacles"],
    damageTags: ["A", "B", "Y"],
    damageTagsSpell: ["Y"],
    spellcastingTags: ["P"],
    miscTags: ["MW", "RCH"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell mage hand}", "{@spell Tasha's hideous laughter}"],
        ability: "cha",
        displayAs: "action",
      },
    ],
  ...
  },
  {
    ...
    trait: [
      {
        name: "Siege Monster",
        entries: ["The ogre deals double damage to objects and structures."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The ogre makes two Bash attacks."],
      },
      {
        name: "Bash",
        entries: [
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell feeblemind}", "{@spell globe of invulnerability}"],
        },
        ability: "cha",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    ac: [
      ...
      {
        ac: 20,
        from: ["with the {@item Wand of Orcus}"],
      },
    ],
    hp: {
      average: 405,
    ...
    spellcasting: [
      ...
      },
      {
        ...
        charges: {
          "1e": ["{@spell circle of death}", "{@spell finger of death}"],
          "2e": ["{@spell power word kill}"],
        },
    ...
    trait: [
      ...
      {
        name: "Special Equipment",
        entries: ["Orcus wields the {@item Wand of Orcus}."],
      },
    ],
    action: [
      {
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Orcus makes one Tail or Necrotic Bolt attack."],
      },
      {
  ...
  },
  {
            ...
            items: [
              {
                ...
                name: "Acid",
                entry:
                  "The target must make a {@dc 17} Constitution saving throw, taking an additional 17 ({@damage 5d6}) acid damage on a failed save, or half as much damage on a successful one.",
              },
              {
                type: "item",
                name: "Blindness",
                entry:
                  "The target takes 5 ({@damage 1d10}) radiant damage. In addition, the target and all other creatures within 20 feet of it must each make a successful {@dc 17} Dexterity saving throw or be {@condition blinded} until the end of the orthon's next turn.",
              },
              {
                type: "item",
                name: "Concussion",
                entry:
                  "The target and each creature within 20 feet of it must make a {@dc 17} Constitution saving throw, taking 13 ({@damage 2d12}) thunder damage on a failed save, or half as much damage on a successful one.",
              },
              {
                type: "item",
                name: "Entanglement",
                entry:
                  "The target must make a successful {@dc 17} Dexterity saving throw or be {@condition restrained} for 1 hour by strands of sticky webbing. The target can escape by taking an action to make a {@dc 17} Strength or Dexterity check and succeeding.",
              },
              {
                type: "item",
                name: "Paralysis",
                entry:
                  "The target takes 22 ({@damage 4d10}) lightning damage and must make a successful {@dc 17} Constitution saving throw or be {@condition paralyzed} for 1 minute. The {@condition paralyzed} target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.",
              },
              {
                type: "item",
                name: "Tracking",
    ...
    senseTags: ["SD", "U"],
    languageTags: ["C", "I", "TP"],
    damageTags: ["A", "F", "I", "L", "O", "R", "T"],
    miscTags: ["AOE", "MW", "RW"],
    conditionInflict: ["blinded", "paralyzed", "poisoned", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Siege Monster",
        entries: ["The phoenix deals double damage to objects and structures."],
      },
    ],
    action: [
      {
    ...
    legendary: [
      {
        name: "Move",
        entries: ["The phoenix moves up to its speed."],
      },
      {
        name: "Peck",
        entries: ["The phoenix makes one beak attack."],
      },
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The redcap makes three Wicked Sickle attacks."],
      },
      {
        name: "Wicked Sickle",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The troll makes one Bite attack and two Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
  ...
  },
  {
    ...
    damageTags: ["P"],
    miscTags: ["MW"],
    conditionInflict: ["frightened", "poisoned", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The statue doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The statue makes two Slam or Rock attacks."],
      },
      {
        name: "Slam",
        entries: [
          ...
          "{@atk mw} {@hit 6} to hit, reach 10 ft., one target. {@h}10 ({@damage 2d6 + 3}) piercing damage. The target must succeed on a {@dc 14} Dexterity saving throw or suffer one of the following effects (choose one or roll a {@dice d6}):",
          {
            ...
            items: [
              ...
              },
              {
                name: "5\u20136: Topple",
                type: "item",
                entries: ["The target is knocked {@condition prone}."],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The shadar-kai makes two Shadow Dagger attacks."],
      },
      {
        name: "Shadow Dagger",
        entries: [
    ...
    traitTags: ["Fey Ancestry", "Magic Resistance"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["C", "E"],
    damageTags: ["N", "P", "Y"],
    ...
    trait: [
      {
        ...
        entries: ["The shadow mastiff can see ethereal creatures and objects."],
      },
      {
  ...
  },
  {
    ...
    legendary: [
      {
        name: "Cast a Spell",
        entries: ["The sibriex uses Spellcasting."],
      },
      {
        name: "Spray Bile",
        entries: ["The sibriex uses Squirt Bile."],
      },
      {
        name: "Warp (Costs 2 Actions)",
        entries: ["The sibriex uses Warp Creature."],
      },
    ],
    variant: [
      {
    ...
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["deafened", "exhaustion", "poisoned"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell mage hand}", "{@spell message}"],
        daily: {
          "2e": ["{@spell dimension door}", "{@spell fear}"],
          "1e": ["{@spell cloudkill}", "{@spell cone of cold}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The skull lord doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["The skull lord makes one Bone Staff or Deathly Ray attack."],
      },
      {
        name: "Move",
        entries: [
  ...
  },
  {
    ...
    traitTags: ["False Appearance", "Spider Climb"],
    senseTags: ["B"],
    languageTags: ["CS"],
    damageTags: ["B", "N"],
    miscTags: ["MW"],
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The spawn of Kyuss requires no air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    traitTags: ["Regeneration", "Unusual Nature"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["CS", "LF"],
    damageTags: ["N", "P", "S"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell Tasha's hideous laughter}"],
        daily: {
          "1e": ["{@spell major image}", "{@spell suggestion}"],
        },
        ability: "cha",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The mage makes three Slam or Eldritch Bolt attacks."],
      },
      {
        name: "Slam",
        entries: [
    ...
    legendary: [
      {
        name: "Slam",
        entries: ["The mage makes one Slam attack."],
      },
      {
        name: "Eldritch Bolt (Costs 2 Actions)",
        entries: ["The mage makes one Eldritch Bolt attack."],
      },
      {
    ...
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["blinded", "poisoned", "restrained"],
    conditionInflictSpell: ["charmed"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    trait: [
      {
        name: "Ambusher",
        entries: ["The mangler has advantage on initiative rolls."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The mangler makes two Claw attacks."],
      },
      {
        name: "Claw",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The seer makes two Comet Staff or Psychic Orb attacks."],
      },
      {
        name: "Comet Staff",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The giant makes two Greatclub or Rock attacks."],
      },
      {
        name: "Greatclub",
        entries: [
    ...
    damageTags: ["B"],
    miscTags: ["MW", "RCH", "RW"],
    conditionInflict: ["charmed", "petrified", "prone"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The eladrin makes two Longsword or Longbow attacks."],
      },
      {
        name: "Longsword",
        entries: [
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell confusion}", "{@spell dominate monster}"],
        },
        ability: "int",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    ac: [
      {
        ac: 17,
        from: ["{@item leather armor|PHB}", "suave defense"],
      },
    ],
    hp: {
      average: 66,
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The commander doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
        name: "Multiattack",
        entries: ["The commander makes two Longsword or Longbow attacks."],
      },
      {
        name: "Longsword",
        entries: [
  ...
  },
  {
    ...
    trait: [
      {
        name: "Unusual Nature",
        entries: ["The warrior doesn't require air, food, drink, or sleep."],
      },
    ],
    action: [
      {
    ...
    attachedItems: ["battleaxe|phb", "longbow|phb"],
    traitTags: ["Unusual Nature"],
    senseTags: ["D"],
    languageTags: ["LF"],
    damageTags: ["P", "S"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          "3e": ["{@spell mislead}", "{@spell modify memory}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    legendary: [
      ...
      {
        name: "Teleport",
        entries: ["Titivilus uses Teleport."],
      },
      {
    ...
    attachedItems: ["silver sword|mtf"],
    traitTags: ["Legendary Resistances", "Magic Resistance", "Regeneration"],
    senseTags: ["SD"],
    actionTags: ["Multiattack", "Teleport"],
    languageTags: ["TP", "XX"],
  ...
  },
  {
    ...
    damageTags: ["I", "P", "S"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["grappled", "paralyzed", "poisoned", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    trait: [
      {
        name: "Hold Breath",
        entries: ["The tortle can hold its breath for 1 hour."],
      },
    ],
    action: [
      {
    ...
    attachedItems: ["light crossbow|phb", "spear|phb"],
    traitTags: ["Hold Breath"],
    languageTags: ["AQ", "C"],
    damageTags: ["P", "S"],
    miscTags: ["MW", "RNG", "RW", "THW"],
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell druidcraft}", "{@spell guidance}"],
        daily: {
          "2e": [
            "{@spell cure wounds}",
            "{@spell hold person}",
  ...
  },
  {
            ...
            items: [
              {
                ...
                name: "Darkvision",
                entry:
                  "The transmuter has {@sense darkvision} out to a range of 60 feet.",
              },
              {
                type: "item",
                name: "Resilience",
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The transmuter makes three Arcane Burst attacks."],
      },
      {
        name: "Arcane Burst",
        entries: [
  ...
  },
  {
    ...
    trait: [
      ...
      {
        name: "Unusual Nature",
        entries: ["The mist doesn't require air or sleep."],
      },
    ],
    action: [
      {
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The warlock makes three Scimitar attacks."],
      },
      {
        name: "Scimitar",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The warlock makes two Dagger attacks."],
      },
      {
        name: "Dagger",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The warlord makes two Greatsword or Short bow attacks."],
      },
      {
        name: "Greatsword",
        entries: [
    ...
    legendary: [
      ...
      {
        name: "Weapon Attack",
        entries: ["The warlord makes one Greatsword or Shortbow attack."],
      },
      {
  ...
  },
  {
    ...
    trait: [
      {
        name: "Amphibious",
        entries: ["The wastrilith can breathe air and water."],
      },
      {
        name: "Corrupt Water",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The myrmidon makes three Trident attacks."],
      },
      {
        name: "Trident",
        entries: [
  ...
  },
  {
    ...
    attachedItems: ["longsword|phb"],
    traitTags: ["Devil's Sight", "Magic Resistance", "Reckless"],
    senseTags: ["SD"],
    actionTags: ["Multiattack"],
    languageTags: ["DR", "I", "TP"],
    damageTags: ["C", "O", "P", "S"],
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The wood woad makes two Club attacks."],
      },
      {
        name: "Club",
        entries: [
          "{@atk mw} {@hit 7} to hit, reach 5 ft., one target. {@h}14 ({@damage 4d4 + 4}) force damage.",
        ],
      },
    ],
    environment: ["forest"],
    ...
    traitTags: ["Regeneration", "Tree Stride"],
    senseTags: ["D"],
    actionTags: ["Multiattack"],
    languageTags: ["S"],
    damageTags: ["O"],
  ...
  },
  {
    ...
    bonus: [
      {
        name: "Low Cunning",
        entries: ["The xvart takes the {@action Disengage} action."],
      },
    ],
    environment: ["hill", "underdark"],
    soundClip: {
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        daily: {
          "1e": ["{@spell burning hands}", "{@spell invisibility}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The xvart makes two Scimitar or Raxivort's Bite attacks."],
      },
      {
        name: "Scimitar",
        entries: [
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Yeenoghu makes three Flail attacks."],
      },
      {
        name: "Flail",
        entries: [
    ...
    legendary: [
      {
        name: "Charge",
        entries: ["Yeenoghu moves up to his speed."],
      },
      {
        name: "Swat Away",
        entries: [
    ...
    languageTags: ["TP", "XX"],
    damageTags: ["A", "O"],
    damageTagsLegendary: ["P"],
    spellcastingTags: ["O"],
    miscTags: ["AOE", "MW", "RCH"],
    conditionInflict: ["paralyzed", "prone"],
    conditionInflictLegendary: ["restrained"],
  ...
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell animal friendship} (snakes only)"],
        daily: {
          "3e": [
            "{@spell darkness}",
            "{@spell entangle}",
    ...
    damageTags: ["A", "B", "I", "P", "S"],
    spellcastingTags: ["F"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["frightened", "grappled", "restrained"],
    conditionInflictSpell: ["charmed", "frightened", "restrained"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The broodguard makes one Bite attack and two Claw attacks."],
      },
      {
        name: "Bite",
        entries: [
    ...
    spellcasting: [
      {
        ...
        daily: {
          3: ["{@spell suggestion}"],
          "2e": ["{@spell detect thoughts}", "{@spell hypnotic pattern}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    spellcasting: [
      {
        ...
        daily: {
          3: ["{@spell suggestion}"],
          "2e": ["{@spell hold person}", "{@spell invisibility}"],
        },
        ability: "cha",
        displayAs: "action",
      },
  ...
  },
  {
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["The zaratan makes one Bite attack and one Stomp attack."],
      },
      {
        name: "Bite",
        entries: [
    ...
    legendary: [
      {
        name: "Stomp",
        entries: ["The zaratan makes one Stomp attack."],
      },
      {
        name: "Move",
        entries: ["The zaratan moves up to its speed."],
      },
      {
        name: "Spit (Costs 2 Actions)",
        entries: ["The zaratan makes one Spit Rock attack."],
      },
      {
  ...
  },
  {
    ...
    attachedItems: ["flail|phb", "longsword|phb"],
    traitTags: [
      "Devil's Sight",
      "Legendary Resistances",
      "Magic Resistance",
    ...
    damageTags: ["F", "N", "O", "R"],
    damageTagsLegendary: ["F"],
    damageTagsSpell: ["B", "F", "N", "P", "S"],
    spellcastingTags: ["O"],
    miscTags: ["MW", "RCH"],
    conditionInflict: ["blinded", "deafened", "poisoned"],
    conditionInflictLegendary: ["frightened"],
    conditionInflictSpell: ["invisible"],
    hasToken: true,
    hasFluff: true,
    hasFluffImages: true,
  },
  {
    ...
    spellcasting: [
      {
        ...
        will: ["{@spell detect magic}", "{@spell locate animals or plants}"],
        daily: {
          "3e": [
            "{@spell dispel magic}",
            "{@spell entangle}",
          ...
          "1e": ["{@spell etherealness}", "{@spell teleport}"],
        },
        ability: "cha",
        displayAs: "action",
      },
    ...
    action: [
      {
        name: "Multiattack",
        entries: ["Zuggtmoy makes three Pseudopod attacks."],
      },
      {
        name: "Pseudopod",
        entries: [
    ...
    legendary: [
      {
        name: "Attack",
        entries: ["Zuggtmoy makes one Pseudopod attack."],
      },
      {
        name: "Exert Will",
        entries: [
